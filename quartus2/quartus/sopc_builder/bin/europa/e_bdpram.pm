...
e_bdpram - description of the module goes here ...

=head1 SYNOPSIS

The e_bdpram class implements ... detailed description of functionality
...
sub new 
{
  ...
  if ($self->{num_words})  {
    if ($self->a_data_width() == $self->b_data_width() ) {
      ...
      &ribbit ("Unable to convert e_dpram-style num_words into e_bdpram
...
sub add_compilation_objects
{
  ...
  my $contents_file;
  if ($this->project()->is_hardcopy_compatible())
  {
