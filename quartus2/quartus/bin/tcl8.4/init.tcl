...
# *** ALTERA *** Add quartus specific directories to auto_path
    set Dir [file join [file dirname [info nameofexecutable]] tcl_packages ]
    if {[lsearch -exact $::auto_path $Dir] < 0} {
	lappend ::auto_path $Dir
    }
    set Dir [file join [file dirname [info nameofexecutable]] tcl_scripts ]
    if {[lsearch -exact $::auto_path $Dir] < 0} {
	lappend ::auto_path $Dir
    }
}
