Altera Complete Design Suite Release 9.0 SP1 README.TXT
=================================================================

This readme.txt file accompanies the Quartus II software version 9.0 SP1. 
After you have installed this update, the Service Pack Installed field 
in the About Quartus II dialog box (Help menu) will indicate "SP1".
