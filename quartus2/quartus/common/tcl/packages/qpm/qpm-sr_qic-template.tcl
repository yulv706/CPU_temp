package provide ::qpm::template::sr_qic 1.0

	# Load Package
package require ::qpm::lib::ccl
package require ::qpm::template::sr

# ----------------------------------------------------------------
#
namespace eval ::qpm::template::sr_qic {
#
...
# ----------------------------------------------------------------
    ...
    variable archive_desc "Archives files, including incremental compilation database files, required for Service Requests."
}

# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::get_revision { } {
#
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::get_description { } {
#
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::get_title { } {
#
# Description: Get title
#
# ----------------------------------------------------------------

	return "Service request with compilation database"
}

# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::is_hidden { } {
#
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::is_hidden_in_ui { } {
#
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::get_rank { } {
#
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::is_default { } {
#
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::get_packages { } {
#
# Description: Returns a list of files to archive
#
# ----------------------------------------------------------------

	set pkgs [::qpm::template::sr::get_packages]
	lappend pkgs qic
...
# ----------------------------------------------------------------
#
proc ::qpm::template::sr_qic::get_archive_files { } {
#
# Description: Returns a list of files to archive
#
# ----------------------------------------------------------------
