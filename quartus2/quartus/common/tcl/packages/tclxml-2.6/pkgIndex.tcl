...
package ifneeded xml::c       2.0 [list load   [file join $dir UNSPECIFIED]]
...
#
#package ifneeded xml::expat  2.0 [list load   [file join $dir tclexpat.dll]]
...
package ifneeded expat 2.0 {
    package require xml::c 2.0
    package require xmldefs 2.0
    package require xml::tclparser 2.0
...
package ifneeded tclparser 2.0 {
    if {[catch {package require xml::c 2.0}]} {
	# No point in trying to load expat
	package require xml::tcl       2.0
	package require xmldefs	       2.0
	package require xml::tclparser 2.0
    } else {
	package require xmldefs        2.0
...
package ifneeded puretclparser 2.0 {
    package require xml::tcl       2.0
    package require xmldefs        2.0
    package require xml::tclparser 2.0
    package provide puretclparser  2.0
}                                        
