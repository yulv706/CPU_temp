...
package ifneeded xml::c       3.0 [list load   [file join $dir UNSPECIFIED]]
package ifneeded xml::tcl     3.0 [list source [file join $dir xml__tcl.tcl]]
...
#
#package ifneeded xml::expat  3.0 [list load   [file join $dir tclexpat.dll]]
#package ifneeded xml::xerces 2.0       [list load   [file join $dir UNSPECIFIED]]
#package ifneeded xml::libxml2 3.0 [list load   [file join $dir UNSPECIFIED]]
...
package ifneeded expat 3.0 {
    package require xml::c 3.0
    package require xmldefs
    package require xml::tclparser 3.0
    catch {package require xml::libxml2 3.0}
    package require xml::expat     3.0
    package provide expat          3.0
}
package ifneeded libxml2 3.0 {
    package require xml::c 3.0
    package require xmldefs
    package require xml::tclparser 3.0
    catch {package require xml::expat 3.0}
    package require xml::libxml2   3.0
    package provide libxml2        3.0
}

# tclparser works with either xml::c or xml::tcl
package ifneeded tclparser 3.0 {
    if {[catch {package require xml::c 3.0}]} {
    ...
    package provide tclparser 3.0
}

# use tcl only (mainly for testing)
package ifneeded puretclparser 3.0 {
    package require xml::tcl       3.0
    package require xmldefs
    package require xml::tclparser 3.0
    package provide puretclparser  3.0
}                                        
...
if {[info tclversion] <= 8.0} {
    ...
    package ifneeded xmldefs        3.0 [list source [file join $dir xml-8.0.tcl]]
    package ifneeded xml::tclparser 3.0 [list source [file join $dir tclparser-8.0.tcl]]
} else {
    package ifneeded sgml           1.9       [list source [file join $dir sgml-8.1.tcl]]
    package ifneeded xmldefs        3.0 [list source [file join $dir xml-8.1.tcl]]
    package ifneeded xml::tclparser 3.0 [list source [file join $dir tclparser-8.1.tcl]]
}
