...
//
// Description : arriagx JTAG Verilog Simulation model
//
//--------------------------------------------------------------------
...
//
// Description : arriagx CRCBLOCK Verilog Simulation model
//
//--------------------------------------------------------------------
...
//
// Description : arriagxIIGXLITE ASMIBLOCK Verilog Simulation model
//
//---------------------------------------------------------------------
...
//
// Description : arriagx LCELL_FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//
// Description : arriagx LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------
...
//
// Description : Simulation model for arriagx DLL block
//
...
//
// Description : arriagx CLKCTRL Verilog simulation model 
//
//------------------------------------------------------------------
...
//               loop feedback counter for the arriagx PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
//               input clock divide counter for the arriagx PLL.
//
///////////////////////////////////////////////////////////////////////////////
    ...
    begin
        ...
        begin
            ...
            begin
                if (clk === 1'bx)
                begin
                    $display("Warning : Invalid transition to 'X' detected on arriagx PLL input clk. This edge will be ignored.");
...
//               C5 output counters of the arriagx PLL.
//
///////////////////////////////////////////////////////////////////////////////
...
module arriagx_lvds_receiver (clk0,
    ...
    begin
        ...
        if (enable_dpa == "on")
        begin
            $display("Warning : DPA Phase tracking is not modeled and once locked, DPA will continue to lock until the next reset is asserted. Please refer to the arriagx device handbook for further details.");
            $display("Time: %0t, Instance: %m", $time);
        end
    end
...
//
// Description : arriagx Termination Atom Verilog simulation model 
//
// ** Note **  : Termination calibration block does not have
//               digital outputs that are observable in PLD by
//               users. The model below is for internal verification.
