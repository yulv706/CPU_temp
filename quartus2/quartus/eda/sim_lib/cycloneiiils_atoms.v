...
//REMStratix IV  //REMHardCopy III parameter  clock_duty_cycle_dependence = "AUTO";
// -------- PORT DECLARATIONS ---------
input portawe;
input portare;
...
`endif
   ram_type = 0;
    ...
    // REMTARPON dataout_a = 'b0;
    // REMTARPON if (mode_is_dp || mode_is_bdp) dataout_b = 'b0;
        dataout_a = 'b0;
...
//--------------------------------------------------------------------
//
// Module Name : cycloneiiils_opregblock
//
// Description : Cyclone III LS opregblock Verilog Simulation model
//
//--------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//--------------------------------------------------------------------
//
// Module Name : cycloneiiils_testaccessblock
//
// Description : Cyclone III LS testaccessblock Verilog Simulation model
//
//--------------------------------------------------------------------
`timescale 1 ps/1 ps
...
//--------------------------------------------------------------------
//
// Module Name : cycloneiiils_volatilekeyblock
//
// Description : Cyclone III LS volatilekeyblock Verilog Simulation model
//
//--------------------------------------------------------------------
`timescale 1 ps/1 ps
