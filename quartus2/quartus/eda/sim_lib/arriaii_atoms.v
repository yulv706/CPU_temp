...
//
// Description : arriaii LCELL_COMB Verilog simulation model 
//
//------------------------------------------------------------------
...
module  arriaii_oscillator 
    ...
    oscena,
//ADD_TARPON    clkout1,
//ADD_TARPON    observableoutputport,
    clkout 
    );
...
//ADD_TARPON    output clkout1;
//ADD_TARPON    output observableoutputport;
    output clkout;

    // INTERNAL parameter and wire
...
`endif
   ram_type = 0;
    ...
    // REMArria II GX dataout_a = 'b0;
    // REMArria II GX if (mode_is_dp || mode_is_bdp) dataout_b = 'b0;
        dataout_a = 'b0;
...
// TCO DELAYS, IO PATH and SETUP-HOLD CHECKS
// These timing paths existed from arriaii, currently not modeled in arriaii
specify
...
//
// Description : Timing simulation model for the arriaii PLL.
...
//
// Description : DEV_FAMILY_Arria II GX arriaii_dqs_enable_ctrl Verilog simulation model
//
// -----------------------------------------------------------
