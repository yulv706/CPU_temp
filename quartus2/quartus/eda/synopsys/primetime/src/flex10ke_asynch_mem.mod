...
/* assumptions:
1. modelsel[13] = 1 && modesel[14] = 0 corresponds to dual port config
2. modesel[13] = 0 && modesel[14] = 0 corresponds to single port config.
3. modesel[14] = 1 corresponds to rom config(don't care about modesel[13] value).
