...
------------------------------------------------------------------
--package alt2gxb is
function get_int_gxb_powerdown_width(number_of_quads, num_quad_per_prot : natural) return natural; 

function get_rx_dwidth_factor(rx_use_double_data_mode : string;
                                      int_rx_use_deserializer_double_data_mode : boolean) return integer;                                     
function get_int_rx_use_deserializer_double_data_mode(protocol : string ; rx_use_deserializer_double_data_mode: string) return boolean; 

function get_int_rx_word_aligner_num_byte(rx_use_deserializer_double_data_mode : string) return integer;
								     
function get_int_tx_dwidth_factor(tx_use_double_data_mode, tx_use_serializer_double_data_mode : string) return integer; 
                                     
function get_num_quad_per_prot(operation_mode, rx_channel_bonding, tx_channel_bonding : string) return integer;                                   
                                    
function get_number_of_quads(number_of_channels, number_channels_per_quad : natural) return integer;

constant	number_channels_per_quad	:	NATURAL	:=	4;

component alt2gxb
	generic (
		cmu_clk_div_inclk_sel	:	string := "auto";
		...
		cmu_pll_inclock_period	:	natural := 5000;
		cmu_pll_log_index	:	natural := 0;
		cmu_pll_loop_filter_resistor_control	:	natural := 0;
		cmu_pll_pfd_clk_select	:	string := "auto";
		cmu_pll_reconfig_inclk_log_index	:	natural := 0;
		cmu_pll_reconfig_inclock_period	:	natural := 5000;
		cmu_pll_reconfig_log_index	:	natural := 0;
		cmu_pll_reconfig_loop_filter_resistor_control	:	natural := 0;
		cmu_refclk_divider_enable	:	string := "auto";
		digitalreset_port_width	:	natural := 1;
		en_local_clk_div_ctrl	:	string := "false";
		enable_fast_recovery_pci_mode	:	string := "false";
		enable_pll_cascade	:	string := "false";
		enable_pll_inclk0_divider	:	string := "false";
		enable_pll_inclk1_divider	:	string := "false";
		enable_pll_inclk2_divider	:	string := "false";
		enable_pll_inclk3_divider	:	string := "false";
		enable_pll_inclk4_divider	:	string := "false";
		enable_pll_inclk5_divider	:	string := "false";
		enable_pll_inclk6_divider	:	string := "false";
		enable_pll_inclk_alt_drive_rx_cru	:	string := "false";
		enable_pll_inclk_drive_rx_cru	:	string := "false";
		enable_reconfig_pll_cascade	:	string := "false";
		enable_reconfig_pll_inclk_drive_rx	:	string := "true";
		enforce_reconfig_refclk_divider	:	string := "auto";
		enforce_refclk_divider	:	string := "auto";
		...
		intended_device_family	:	string := "stratixiigx";
		loopback_mode	:	string := "none";
		lpm_hint	:	string := "UNUSED";
		lpm_type	:	string := "alt2gxb";
		number_of_channels	:	natural := 1;
		operation_mode	:	string := "duplex";
		pll_inclk0_inclock_period	:	natural := 5000;
		pll_inclk1_inclock_period	:	natural := 5000;
		pll_inclk2_inclock_period	:	natural := 5000;
		pll_inclk3_inclock_period	:	natural := 5000;
		pll_inclk4_inclock_period	:	natural := 5000;
		pll_inclk5_inclock_period	:	natural := 5000;
		pll_inclk6_inclock_period	:	natural := 5000;
		pll_legal_multiplier_list	:	string := "disable_4_5_mult_in_6g";
		...
		rx_cru_inclock_period	:	natural := 5000;
		rx_cru_log_index	:	natural := 0;
		rx_cru_pre_divide_by	:	natural := 1;
		rx_cruclk_width	:	natural := 1;
		...
		rx_digitalreset_port_width	:	natural := 0;
		...
		rx_rate_match_fifo_read_mux_sel	:	string := "auto";
		rx_rate_match_fifo_write_mux_sel	:	string := "auto";
		...
		rx_use_local_refclk	:	string := "false";
		...
		transmitter_termination	:	string := "off";
		tx_8b_10b_compatibility_mode	:	string := "false";
		tx_8b_10b_mode	:	string := "none";
		tx_allow_polarity_inversion	:	string := "false";
		tx_analog_power	:	string := "1.5V";
		tx_channel_bonding	:	string := "indv";
		tx_channel_width	:	natural := 8;
		tx_common_mode	:	string := "0.75V";
		tx_data_rate	:	natural := 1000;
		tx_data_rate_remainder	:	natural := 0;
		tx_digitalreset_port_width	:	natural := 0;
		tx_divider_refclk_select	:	string := "auto";
		...
		tx_enable_slew_rate	:	string := "false";
		...
		tx_pll_reconfig_sim_clkout_phase_shift	:	natural := 0;
		...
		tx_refclk_select	:	string := "auto";
		tx_rxdetect_ctrl	:	natural := 0;
	...
	port(
		...
		coreclkout	:	out std_logic_vector(get_number_of_quads(number_of_channels, number_channels_per_quad)-1 downto 0);
		debug_rx_phase_comp_fifo_error	:	out std_logic_vector((number_of_channels)-1 downto 0);
		debug_tx_phase_comp_fifo_error	:	out std_logic_vector((number_of_channels)-1 downto 0);
		fixedclk	:	in std_logic := '0';
		gxb_enable	:	in std_logic_vector(0 downto 0) := (others => '1');
		gxb_powerdown	:	in std_logic_vector(get_int_gxb_powerdown_width(get_number_of_quads(number_of_channels, number_channels_per_quad), get_num_quad_per_prot(operation_mode, rx_channel_bonding, tx_channel_bonding))-1 downto 0) := (others => '0');
		...
		pll_inclk_alt	:	in std_logic := '0';
		pll_inclk_rx_cruclk	:	in std_logic_vector(reconfig_pll_inclk_width-1 downto 0);
		pll_locked	:	out std_logic_vector(get_number_of_quads(number_of_channels, number_channels_per_quad)-1 downto 0);
		pll_locked_alt	:	out std_logic_vector(get_number_of_quads(number_of_channels, number_channels_per_quad)-1 downto 0);
		powerdn	:	in std_logic_vector((number_of_channels*2)-1 downto 0) := (others => '0');
		reconfig_clk	:	in std_logic := '0';
		reconfig_fromgxb	:	out std_logic_vector(get_number_of_quads(number_of_channels, number_channels_per_quad)-1 downto 0);
		reconfig_fromgxb_oe	:	out std_logic_vector(get_number_of_quads(number_of_channels, number_channels_per_quad)-1 downto 0);
		reconfig_togxb	:	in std_logic_vector(2 downto 0);
		rx_a1a2size	:	in std_logic_vector(number_of_channels-1 downto 0) := (others => '0');
		rx_a1a2sizeout	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		rx_a1detect	:	out std_logic_vector((number_of_channels*get_int_rx_word_aligner_num_byte(rx_use_deserializer_double_data_mode))-1 downto 0);
		rx_a2detect	:	out std_logic_vector((number_of_channels*get_int_rx_word_aligner_num_byte(rx_use_deserializer_double_data_mode))-1 downto 0);
		...
		rx_channelaligned	:	out std_logic_vector(get_number_of_quads(number_of_channels, number_channels_per_quad)-1 downto 0);
		rx_clkout	:	out std_logic_vector((number_of_channels)-1 downto 0);
		rx_coreclk	:	in std_logic_vector(number_of_channels-1 downto 0) := (others => '0');
		rx_cruclk	:	in std_logic_vector(rx_cruclk_width-1 downto 0) := (others => '0');
		rx_cruclk_alt	:	in std_logic_vector(rx_cruclk_width-1 downto 0) := (others => '0');
		rx_ctrldetect	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		rx_datain	:	in std_logic_vector(number_of_channels-1 downto 0);
		...
		rx_disperr	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		...
		rx_errdetect	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		...
		rx_k1detect	:	out std_logic_vector((number_of_channels*get_int_rx_word_aligner_num_byte(rx_use_deserializer_double_data_mode))-1 downto 0);
		...
		rx_patterndetect	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		...
		rx_rmfifodatadeleted	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		rx_rmfifodatainserted	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		...
		rx_runningdisp	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		...
		rx_syncstatus	:	out std_logic_vector((number_of_channels*get_rx_dwidth_factor(rx_use_double_data_mode, get_int_rx_use_deserializer_double_data_mode(protocol, rx_use_deserializer_double_data_mode)))-1 downto 0);
		...
		tx_ctrlenable	:	in std_logic_vector((get_int_tx_dwidth_factor(tx_use_double_data_mode, tx_use_serializer_double_data_mode)*number_of_channels)-1 downto 0) := (others => '0');
		tx_datain	:	in std_logic_vector((tx_channel_width*number_of_channels)-1 downto 0);
		tx_datainfull	:	in std_logic_vector((44*number_of_channels)-1 downto 0);
		...
		tx_dispval	:	in std_logic_vector((get_int_tx_dwidth_factor(tx_use_double_data_mode, tx_use_serializer_double_data_mode)*number_of_channels)-1 downto 0) := (others => '0');
		tx_forcedisp	:	in std_logic_vector((get_int_tx_dwidth_factor(tx_use_double_data_mode, tx_use_serializer_double_data_mode)*number_of_channels)-1 downto 0) := (others => '0');
...
attribute syn_black_box of altufm_spi : component is true;
...
attribute syn_black_box of altfp_log : component is true;
...
attribute syn_black_box of altfp_exp : component is true;
...
attribute syn_black_box of altfp_div : component is true;
...
attribute syn_black_box of altfp_compare : component is true;
...
attribute syn_black_box of alt_oct : component is true;
...
attribute syn_black_box of alt2gxb_reconfig : component is true;
...
attribute syn_black_box of altmemmult : component is true;
...
attribute syn_black_box of altpll_reconfig : component is true;
...
attribute syn_black_box of altcal_dpa_pll : component is true;
...
attribute syn_black_box of alt4gxb : component is true;
...
component sld_mod_ram_rom
	generic (
		...
		lpm_hint	:	string := "UNUSED";
		lpm_type	:	string := "sld_mod_ram_rom";
		node_name	:	natural := 0;
		numwords	:	natural := 1;
		...
		widthad	:	natural := 16	);
	port(
		address	:	out std_logic_vector(WIDTHAD-1 downto 0);
		data_read	:	in std_logic_vector(WIDTH_WORD-1 downto 0);
		data_write	:	out std_logic_vector(WIDTH_WORD-1 downto 0);
...
attribute syn_black_box of sld_mod_ram_rom : component is true;
...
attribute syn_black_box of altremote_update : component is true;
...
attribute syn_black_box of altecc_decoder : component is true;
...
attribute syn_black_box of altotp : component is true;
...
attribute syn_black_box of altfp_add_sub : component is true;
...
attribute syn_black_box of a_graycounter : component is true;
...
attribute syn_black_box of altasmi_parallel : component is true;
...
attribute syn_black_box of altmult_complex : component is true;
...
attribute syn_black_box of altserial_flash_loader : component is true;
...
attribute syn_black_box of altfp_matrix_mult : component is true;
...
attribute syn_black_box of altstratixii_oct : component is true;
...
attribute syn_black_box of altdll : component is true;
...
attribute syn_black_box of altiobuf_out : component is true;
...
attribute syn_black_box of altecc_encoder : component is true;
...
attribute syn_black_box of altdq : component is true;
...
attribute syn_black_box of dcfifo_mixed_widths : component is true;
...
attribute syn_black_box of altufm_i2c : component is true;
...
attribute syn_black_box of altufm_none : component is true;
...
attribute syn_black_box of altsquare : component is true;
...
attribute syn_black_box of alt_adv_seu_detection : component is true;
...
attribute syn_black_box of altmem_init : component is true;
...
attribute syn_black_box of altfp_inv : component is true;
...
attribute syn_black_box of altufm_osc : component is true;
...
attribute syn_black_box of altfp_inv_sqrt : component is true;
...
attribute syn_black_box of altfp_convert : component is true;
...
attribute syn_black_box of alt_oct_power : component is true;
...
attribute syn_black_box of altiobuf_in : component is true;
...
attribute syn_black_box of altufm_parallel : component is true;
...
attribute syn_black_box of altiobuf_bidir : component is true;
...
attribute syn_black_box of altclkctrl : component is true;
...
attribute syn_black_box of alt_oct_aii : component is true;
...
attribute syn_black_box of altdqs : component is true;
...
attribute syn_black_box of alt_cal : component is true;
...
attribute syn_black_box of altdq_dqs : component is true;
...
attribute syn_black_box of altfp_sqrt : component is true;
...
attribute syn_black_box of altsource_probe : component is true;
...
attribute syn_black_box of altparallel_flash_loader : component is true;

--clearbox auto-generated components begin
end altera_mf_components;
package body altera_mf_components is

	function get_int_gxb_powerdown_width(number_of_quads, num_quad_per_prot : natural) return natural is 
                                      
    variable int_gxb_powerdown_width : natural;
    begin
        if (( number_of_quads mod num_quad_per_prot ) /= 0) then
        int_gxb_powerdown_width :=  ( number_of_quads/num_quad_per_prot ) + 1 ;
            else
            int_gxb_powerdown_width := ( number_of_quads/num_quad_per_prot );
        end if;
        
        return int_gxb_powerdown_width;

    end get_int_gxb_powerdown_width;
    
    function get_rx_dwidth_factor(rx_use_double_data_mode : string;
                                      int_rx_use_deserializer_double_data_mode : boolean) return integer is
                                       
    variable int_rx_dwidth_factor : integer;
    begin
        if ((rx_use_double_data_mode = "true") and (int_rx_use_deserializer_double_data_mode = TRUE)) then
        int_rx_dwidth_factor := 4;
             elsif ((rx_use_double_data_mode = "false") and (int_rx_use_deserializer_double_data_mode = FALSE)) then
             int_rx_dwidth_factor := 1;
            	elsif ((rx_use_double_data_mode = "true") or (int_rx_use_deserializer_double_data_mode = TRUE)) then
                int_rx_dwidth_factor := 2;
                	else
                	int_rx_dwidth_factor := 1;
        end if;

        return int_rx_dwidth_factor;

    end get_rx_dwidth_factor;
    

	function get_int_rx_use_deserializer_double_data_mode(protocol : string; 
	                                                          rx_use_deserializer_double_data_mode: string) return boolean is 
    variable int_rx_use_deserializer_double_data_mode : boolean;
    begin
        if (( protocol = "gige" ) or ( protocol = "xaui" ) or ( protocol = "pipe" )) then
            int_rx_use_deserializer_double_data_mode := FALSE;
        else
            if(rx_use_deserializer_double_data_mode = "true") then
               int_rx_use_deserializer_double_data_mode := TRUE;
            else
               int_rx_use_deserializer_double_data_mode := FALSE;
           end if;
        end if;

        return int_rx_use_deserializer_double_data_mode;

    end get_int_rx_use_deserializer_double_data_mode;
    
    function get_int_rx_word_aligner_num_byte(rx_use_deserializer_double_data_mode : string) return integer is
	variable int_rx_word_aligner_num_byte : integer;
    begin
        if ( rx_use_deserializer_double_data_mode = "true" ) then
        int_rx_word_aligner_num_byte := 2;
        else
        int_rx_word_aligner_num_byte := 1;
        end if;

        return int_rx_word_aligner_num_byte;

    end get_int_rx_word_aligner_num_byte;
    

	function get_int_tx_dwidth_factor(tx_use_double_data_mode, tx_use_serializer_double_data_mode : string) return integer is 
    variable tx_dwidth_factor : integer;
    begin
        if ((tx_use_double_data_mode = "true" ) and ( tx_use_serializer_double_data_mode = "true")) then
        tx_dwidth_factor := 4;
             elsif ((tx_use_double_data_mode = "false" ) and ( tx_use_serializer_double_data_mode = "false")) then
             tx_dwidth_factor := 1;
            	elsif ((tx_use_double_data_mode = "true" ) or ( tx_use_serializer_double_data_mode = "true")) then
                tx_dwidth_factor := 2;
                	else
                	tx_dwidth_factor := 1;
        end if;

        return tx_dwidth_factor;

    end get_int_tx_dwidth_factor;
    

    function get_num_quad_per_prot(operation_mode, rx_channel_bonding, tx_channel_bonding : string) return integer is                                  
    variable num_quad_per_prot : integer;
    begin
    	if ( operation_mode = "rx" ) then
    		if  (( rx_channel_bonding /= "x8" ) and ( rx_channel_bonding /= "x8_unbundled" )) then
    		num_quad_per_prot := 1;
    		else
    		num_quad_per_prot :=2;
    			if ( operation_mode = "tx" ) then 
    			if  (( tx_channel_bonding /= "x8" ) and ( tx_channel_bonding /= "x8_unbundled" )) then	
				num_quad_per_prot := 1;
    			else
    			num_quad_per_prot :=2;
    				if (( tx_channel_bonding /= "x8" ) and ( tx_channel_bonding /= "x8_unbundled" )) then
    	...
    	return num_quad_per_prot;

    end get_num_quad_per_prot;
    

    
	function get_number_of_quads(number_of_channels, number_channels_per_quad : natural) return integer is
	variable number_of_quads : integer;
	begin
		if ( ( number_of_channels / number_channels_per_quad ) <= 0 ) then
		number_of_quads := 1;
		elsif ( number_of_channels mod number_channels_per_quad ) /= 0 then
		number_of_quads := ( number_of_channels / number_channels_per_quad ) + 1;
		else
		number_of_quads := number_of_channels / number_channels_per_quad;
		end if;
		
		return number_of_quads;
		
	end get_number_of_quads;
	end;