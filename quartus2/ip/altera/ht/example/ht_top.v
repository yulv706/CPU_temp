...
module ht_top (
	...
	defparam
		...
		ht_ec8_inst.DeviceId = 16'h0000,
		ht_ec8_inst.SubSystemId = 16'h0000,
		ht_ec8_inst.SubSystemVendId = 16'h0000,
		ht_ec8_inst.RevisionId = 8'h00,
		ht_ec8_inst.ClassCode = 24'h000000,
		ht_ec8_inst.BAR0MatchMask = 32'hFFF00000,
		ht_ec8_inst.BAR0AndMask = 32'hFFF00000,
		ht_ec8_inst.BAR0OrMask = 32'h00000008,
		ht_ec8_inst.BAR1MatchMask = 32'h00000000,
		ht_ec8_inst.BAR1AndMask = 32'h00000000,
		ht_ec8_inst.BAR1OrMask = 32'h00000000,
		ht_ec8_inst.BAR2MatchMask = 32'h00000000,
		ht_ec8_inst.BAR2AndMask = 32'h00000000,
		ht_ec8_inst.BAR2OrMask = 32'h00000000,
		ht_ec8_inst.BAR3MatchMask = 32'h00000000,
		ht_ec8_inst.BAR3AndMask = 32'h00000000,
...
// Retrieval info: <MEGACORE title="HyperTransport MegaCore Function"  version="1.3.2"  iptb_version="v1.2.7 build38"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION active_core="ht_ec8" >
// Retrieval info:   <STATIC_SECTION>
// Retrieval info:    <PRIVATES>
// Retrieval info:     <NAMESPACE name = "parameterization">
// Retrieval info:      <PRIVATE name = "clock_domain" value="3"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "device_id" value="0x0000"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "class_code" value="0x000000"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "bar_0_io" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_1_io" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_2_io" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_3_io" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_4_io" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_5_io" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_1" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_1_prefetchable_memory" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_1_mem_range" value="16 MBytes"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_0" value="1"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_0_prefetchable_memory" value="1"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_0_mem_range" value="1 MBytes"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_2" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_2_prefetchable_memory" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_2_mem_range" value="16 MBytes"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_3" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_3_prefetchable_memory" value="0"  type="BOOLEAN"  enable="1" />
// Retrieval info:      <PRIVATE name = "bar_3_mem_range" value="16 MBytes"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "claim_compat" value="0"  type="BOOLEAN"  enable="1" />
...
// Retrieval info:     <CONSTANT name = "CLKDMN" value="3"  type="INTEGER" />
...
// Retrieval info:     <CONSTANT name = "DeviceId" value="0000"  type="HDL_VECTOR"  radix="HEX"  width="16"  vhdl_type="STD_LOGIC_VECTOR" />
...
// Retrieval info:     <CONSTANT name = "ClassCode" value="000000"  type="HDL_VECTOR"  radix="HEX"  width="24"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR0MatchMask" value="FFF00000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR0AndMask" value="FFF00000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR0OrMask" value="00000008"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR1MatchMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR1AndMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR1OrMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR2MatchMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR2AndMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR2OrMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR3MatchMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:     <CONSTANT name = "BAR3AndMask" value="00000000"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
...
// Retrieval info:     <CONSTANT name = "CLAIM_COMPAT" value="0"  type="INTEGER" />
// Retrieval info:    </CONSTANTS>
...
// Retrieval info:     <PORT name = "RefClk" direction="INPUT"  connect_to="RefClk"  default="NODEFVAL"  width="1"  description="" />
