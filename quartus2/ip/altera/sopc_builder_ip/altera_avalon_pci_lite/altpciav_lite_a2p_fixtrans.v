...
//
// $Id: altpciav_lite_a2p_fixtrans.v,v 1.1 2007/06/06 09:53:42 lfching Exp $
//
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////

module altpciav_lite_a2p_fixtrans
  ...
  (
   ...
   //always @(AdTrAddress_i or AdTrReadVld_i)
   always @(AdTrReadVld_i)
     begin
        table_read 
          = validate_entry((AdTrAddress_i >> 1) % 
                           CB_A2P_ADDR_MAP_NUM_ENTRIES) ;
...
endmodule // altpciav_lite_a2p_fixtrans
