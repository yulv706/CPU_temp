...
# PCI_CF_Device_Family = Cyclone II
...
proc sanity_checks { speed device core  } {
        ...
        # Check if customer is targeting on Cyclone II device, EP2C
        set device_family [lindex [get_part_info -family $device] 0] 
        if { $device_family == "Cyclone II" } {
        } else {
                puts "Error: This constraint file is specific to Cyclone II device family."
                puts "       You are not targeting a Cyclone II device."
        ...
        if { ($core == "MT64" || $core == "T64") && ($pin_count == "208" || $pin_count == "256" ||$pin_count =="240") } {
                puts "Error: Altera does not support the pci_mt64 and pci_t64 function in Q208, Q240 and F256 packages"
                puts "       Change the Cyclone II device package in your project"
                error ""
        }       
        ...
        if { $device_speed == "8" && $speed == "66" } {
                puts "Error: Altera supports 66 MHz PCI in Cyclone II -6 or -7 device speed grades only"
...
proc pci_pin_asgn {device full_64 master core pin_list no_pins got_prefix got_suffix prefix suffix use_dedicated_clk } {
        ...
        # get pin out group name
       	set pinout_group [get_pinout_group_name $device_type\_$pin_count $core]
...
# PCI pin assignments
#**********************
proc get_pinout_group_name { device_no_speed core } {

        set pinout_group "nil"
        
        if { $core == "MT64" || $core == "MT32" } { 
                set core_bit [string range $core 2 3]
        } else {
                set core_bit [string range $core 1 2]
        }
        
        set device_core $device_no_speed\_$core_bit

        # array name == pin
        array set pin { EP2C5_208_32 	2C5_2C8_Q208_32 			}
        array set pin { EP2C8_208_32 	2C5_2C8_Q208_32				}     
          
        array set pin { EP2C5_256_32 	2C5_F256_32					}  
        array set pin { EP2C8_256_32 	2C8_F256_32					}  
        array set pin { EP2C15_256_32 	2C20_F256_32				}   
        array set pin { EP2C20_256_32 	2C20_F256_32				}  

        array set pin { EP2C20_240_32 	2C20_Q240_32				}  
        array set pin { EP2C15_484_32 	2C20_2C35_2C50_F484_32		}           
        array set pin { EP2C20_484_32 	2C20_2C35_2C50_F484_32		}
        array set pin { EP2C35_484_32 	2C20_2C35_2C50_F484_32		}       
        array set pin { EP2C50_484_32 	2C20_2C35_2C50_F484_32		}
        array set pin { EP2C15_484_64 	2C20_2C35_2C50_F484_64	 	}       
        array set pin { EP2C20_484_64 	2C20_2C35_2C50_F484_64	 	}
        array set pin { EP2C35_484_64 	2C20_2C35_2C50_F484_64	 	}
        array set pin { EP2C50_484_64 	2C20_2C35_2C50_F484_64	 	}
        
        array set pin { EP2C35_672_32 	2C35_2C50_2C70_F672_both	 	} 
        array set pin { EP2C50_672_32 	2C35_2C50_2C70_F672_both	 	}         
        array set pin { EP2C70_672_32 	2C35_2C50_2C70_F672_both	 	}         
        array set pin { EP2C35_672_64 	2C35_2C50_2C70_F672_both	 	} 
        array set pin { EP2C50_672_64 	2C35_2C50_2C70_F672_both	 	}         
        array set pin { EP2C70_672_64 	2C35_2C50_2C70_F672_both	 	}   
                        
        array set pin { EP2C70_896_64	2C70_F896_both				}  
        array set pin { EP2C70_896_32	2C70_F896_both				}  
...
proc 2C5_2C8_Q208_32_lower_32bit_core { use_dedicated_clk } {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	
	if {$use_dedicated_clk} {	
		set_location_assignment PIN_130 -to $clk
	} else {	
		set_location_assignment PIN_30 -to $clk
	} 
	
	set_location_assignment PIN_152 -to $ad\[0\]
	set_location_assignment PIN_151 -to $ad\[1\]
	set_location_assignment PIN_150 -to $ad\[2\]
	set_location_assignment PIN_149 -to $ad\[3\]
	set_location_assignment PIN_147 -to $ad\[4\]
	set_location_assignment PIN_146 -to $ad\[5\]
	set_location_assignment PIN_144 -to $ad\[6\]
	set_location_assignment PIN_143 -to $ad\[7\]
	set_location_assignment PIN_137 -to $ad\[8\]
	set_location_assignment PIN_106 -to $ad\[9\]
	set_location_assignment PIN_105 -to $ad\[10\]
	set_location_assignment PIN_48 -to $ad\[11\]
	set_location_assignment PIN_47 -to $ad\[12\]
	set_location_assignment PIN_46 -to $ad\[13\]
	set_location_assignment PIN_45 -to $ad\[14\]
	set_location_assignment PIN_44 -to $ad\[15\]
	set_location_assignment PIN_43 -to $ad\[16\]
	set_location_assignment PIN_41 -to $ad\[17\]
	set_location_assignment PIN_40 -to $ad\[18\]
	set_location_assignment PIN_39 -to $ad\[19\]
	set_location_assignment PIN_35 -to $ad\[20\]
	set_location_assignment PIN_34 -to $ad\[21\]
	set_location_assignment PIN_33 -to $ad\[22\]
	set_location_assignment PIN_31 -to $ad\[23\]
	set_location_assignment PIN_15 -to $ad\[24\]
	set_location_assignment PIN_14 -to $ad\[25\]
	set_location_assignment PIN_12 -to $ad\[26\]
	set_location_assignment PIN_11 -to $ad\[27\]
	set_location_assignment PIN_10 -to $ad\[28\]
	set_location_assignment PIN_8 -to $ad\[29\]
	set_location_assignment PIN_6 -to $ad\[30\]
	set_location_assignment PIN_5 -to $ad\[31\]
	set_location_assignment PIN_134 -to $trdyn
	set_location_assignment PIN_133 -to $framen
	set_location_assignment PIN_132 -to $rstn
	set_location_assignment PIN_128 -to $irdyn
	set_location_assignment PIN_127 -to $stopn
	set_location_assignment PIN_135 -to $devseln
	set_location_assignment PIN_118 -to $cben\[0\]
	set_location_assignment PIN_116 -to $cben\[1\]
	set_location_assignment PIN_115 -to $cben\[2\]
	set_location_assignment PIN_114 -to $cben\[3\]
	set_location_assignment PIN_113 -to $par
	set_location_assignment PIN_112 -to $perrn
	set_location_assignment PIN_110 -to $serrn
	set_location_assignment PIN_139 -to $idsel
	set_location_assignment PIN_141 -to $intan
}

# Upper PCI 32-bit Core
proc 2C5_2C8_Q208_32_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
}

# Master/Target PCI Core Only
proc 2C5_2C8_Q208_32_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_138 -to $gntn
	set_location_assignment PIN_142 -to $reqn
}
...
# Lower PCI 32-bit Core
proc 2C20_Q240_32_lower_32bit_core { use_dedicated_clk } {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	
	# Add this if switching to dedicated clock capabilities
	if {$use_dedicated_clk} {	
		set_location_assignment PIN_46 -to $clk
	} else {	
		set_location_assignment PIN_46 -to $clk
	}
	set_location_assignment PIN_178 -to $ad\[0\]
	set_location_assignment PIN_177 -to $ad\[1\]
	set_location_assignment PIN_175 -to $ad\[2\]
	set_location_assignment PIN_174 -to $ad\[3\]
	set_location_assignment PIN_171 -to $ad\[4\]
	set_location_assignment PIN_170 -to $ad\[5\]
	set_location_assignment PIN_167 -to $ad\[6\]
	set_location_assignment PIN_168 -to $ad\[7\]
	set_location_assignment PIN_166 -to $ad\[8\]
	set_location_assignment PIN_165 -to $ad\[9\]
	set_location_assignment PIN_162 -to $ad\[10\]
	set_location_assignment PIN_161 -to $ad\[11\]
	set_location_assignment PIN_159 -to $ad\[12\]
	set_location_assignment PIN_58 -to $ad\[13\]
	set_location_assignment PIN_57 -to $ad\[14\]
	set_location_assignment PIN_56 -to $ad\[15\]
	set_location_assignment PIN_55 -to $ad\[16\]
	set_location_assignment PIN_54 -to $ad\[17\]
	set_location_assignment PIN_52 -to $ad\[18\]
	set_location_assignment PIN_51 -to $ad\[19\]
	set_location_assignment PIN_50 -to $ad\[20\]
	set_location_assignment PIN_47 -to $ad\[21\]
	set_location_assignment PIN_42 -to $ad\[22\]
	set_location_assignment PIN_41 -to $ad\[23\]
	set_location_assignment PIN_39 -to $ad\[24\]
	set_location_assignment PIN_38 -to $ad\[25\]
	set_location_assignment PIN_37 -to $ad\[26\]
	set_location_assignment PIN_21 -to $ad\[27\]
	set_location_assignment PIN_20 -to $ad\[28\]
	set_location_assignment PIN_16 -to $ad\[29\]
	set_location_assignment PIN_14 -to $ad\[30\]
	set_location_assignment PIN_13 -to $ad\[31\]
	set_location_assignment PIN_150 -to $trdyn
	set_location_assignment PIN_136 -to $framen
	set_location_assignment PIN_153 -to $rstn
	set_location_assignment PIN_137 -to $irdyn
	set_location_assignment PIN_135 -to $stopn
	set_location_assignment PIN_140 -to $devseln
	set_location_assignment PIN_128 -to $cben\[0\]
	set_location_assignment PIN_130 -to $cben\[1\]
	set_location_assignment PIN_131 -to $cben\[2\]
	set_location_assignment PIN_132 -to $cben\[3\]
	set_location_assignment PIN_157 -to $par
	set_location_assignment PIN_125 -to $perrn
	set_location_assignment PIN_126 -to $serrn
	set_location_assignment PIN_149 -to $idsel
	set_location_assignment PIN_156 -to $intan
...
# Upper PCI 32-bit Core
proc 2C20_Q240_32_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
}

# Master/Target PCI Core Only
proc 2C20_Q240_32_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_141 -to $gntn
	set_location_assignment PIN_155 -to $reqn
}
...
# Quartus II Format
# 	set_global_assignment -name "DEVICE" "EP2C8F256C6" 

# Lower PCI 32-bit Core
proc 2C5_F256_32_lower_32bit_core { use_dedicated_clk } {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	
	if {$use_dedicated_clk} {	
		set_location_assignment PIN_J15 -to $clk
	} else {	
		set_location_assignment PIN_K2 -to $clk
	} 
	
	set_location_assignment PIN_H16 -to $rstn
	set_location_assignment PIN_J12 -to $trdyn
	set_location_assignment PIN_H12 -to $framen
	set_location_assignment PIN_K15 -to $irdyn
	set_location_assignment PIN_K16 -to $stopn
	set_location_assignment PIN_G15 -to $devseln
	set_location_assignment PIN_F15 -to $idsel
	set_location_assignment PIN_G12 -to $intan
	set_location_assignment PIN_L16 -to $cben\[0\]
	set_location_assignment PIN_L15 -to $cben\[1\]
	set_location_assignment PIN_M15 -to $cben\[2\]
	set_location_assignment PIN_P14 -to $cben\[3\]
	set_location_assignment PIN_N16 -to $par
	set_location_assignment PIN_N15 -to $perrn
	set_location_assignment PIN_D4 -to $serrn
	set_location_assignment PIN_C14 -to $ad\[0\]
	set_location_assignment PIN_D13 -to $ad\[1\]
	set_location_assignment PIN_D15 -to $ad\[2\]
	set_location_assignment PIN_D16 -to $ad\[3\]
	set_location_assignment PIN_E16 -to $ad\[4\]
	set_location_assignment PIN_G16 -to $ad\[5\]
	set_location_assignment PIN_M12 -to $ad\[6\]
	set_location_assignment PIN_M16 -to $ad\[7\]
	set_location_assignment PIN_N12 -to $ad\[8\]
	set_location_assignment PIN_P15 -to $ad\[9\]
	set_location_assignment PIN_P16 -to $ad\[10\]
	set_location_assignment PIN_P3 -to $ad\[11\]
	set_location_assignment PIN_P2 -to $ad\[12\]
	set_location_assignment PIN_P1 -to $ad\[13\]
	set_location_assignment PIN_N2 -to $ad\[14\]
	set_location_assignment PIN_N1 -to $ad\[15\]
	set_location_assignment PIN_M3 -to $ad\[16\]
	set_location_assignment PIN_M2 -to $ad\[17\]
	set_location_assignment PIN_M1 -to $ad\[18\]
	set_location_assignment PIN_L3 -to $ad\[19\]
	set_location_assignment PIN_L2 -to $ad\[20\]
	set_location_assignment PIN_L1 -to $ad\[21\]
	set_location_assignment PIN_K5 -to $ad\[22\]
	set_location_assignment PIN_K4 -to $ad\[23\]
	set_location_assignment PIN_K1 -to $ad\[24\]
	set_location_assignment PIN_E4 -to $ad\[25\]
	set_location_assignment PIN_E3 -to $ad\[26\]
	set_location_assignment PIN_E2 -to $ad\[27\]
	set_location_assignment PIN_D5 -to $ad\[28\]
	set_location_assignment PIN_D3 -to $ad\[29\]
	set_location_assignment PIN_C2 -to $ad\[30\]
	set_location_assignment PIN_C1 -to $ad\[31\]
}

# Upper PCI 32-bit Core
proc 2C5_F256_32_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
}

# Master/Target PCI Core Only
proc 2C5_F256_32_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_F16 -to $gntn
	set_location_assignment PIN_G13 -to $reqn
}
...
# Lower PCI 32-bit Core
proc 2C8_F256_32_lower_32bit_core { use_dedicated_clk } {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	...
	set_location_assignment PIN_N16 -to $par
	set_location_assignment PIN_N15 -to $perrn
	set_location_assignment PIN_K13 -to $serrn
	set_location_assignment PIN_C14 -to $ad\[0\]
	set_location_assignment PIN_C15 -to $ad\[1\]
	set_location_assignment PIN_C16 -to $ad\[2\]
	set_location_assignment PIN_D13 -to $ad\[3\]
	set_location_assignment PIN_D15 -to $ad\[4\]
	set_location_assignment PIN_D16 -to $ad\[5\]
	set_location_assignment PIN_E13 -to $ad\[6\]
	set_location_assignment PIN_E15 -to $ad\[7\]
	set_location_assignment PIN_E16 -to $ad\[8\]
	set_location_assignment PIN_F13 -to $ad\[9\]
	set_location_assignment PIN_G16 -to $ad\[10\]
	set_location_assignment PIN_P3 -to $ad\[11\]
	set_location_assignment PIN_P2 -to $ad\[12\]
	set_location_assignment PIN_P1 -to $ad\[13\]
	set_location_assignment PIN_N4 -to $ad\[14\]
	set_location_assignment PIN_N3 -to $ad\[15\]
	set_location_assignment PIN_N2 -to $ad\[16\]
	set_location_assignment PIN_N1 -to $ad\[17\]
	set_location_assignment PIN_M3 -to $ad\[18\]
	set_location_assignment PIN_M2 -to $ad\[19\]
	set_location_assignment PIN_M1 -to $ad\[20\]
	set_location_assignment PIN_L2 -to $ad\[21\]
	set_location_assignment PIN_L1 -to $ad\[22\]
	set_location_assignment PIN_K5 -to $ad\[23\]
	set_location_assignment PIN_K4 -to $ad\[24\]
	set_location_assignment PIN_K1 -to $ad\[25\]	
	set_location_assignment PIN_E4 -to $ad\[26\]
	set_location_assignment PIN_E3 -to $ad\[27\]	
	set_location_assignment PIN_E2 -to $ad\[28\]
	set_location_assignment PIN_E1 -to $ad\[29\]
	set_location_assignment PIN_D2 -to $ad\[30\]
	set_location_assignment PIN_D1 -to $ad\[31\]
}

# Upper PCI 32-bit Core
proc 2C8_F256_32_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
}

# Master/Target PCI Core Only
proc 2C8_F256_32_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_F16 -to $gntn
	set_location_assignment PIN_G13 -to $reqn
}
...
# Lower PCI 32-bit Core
proc 2C20_F256_32_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_H16 -to $rstn
	set_location_assignment PIN_J12 -to $trdyn
	set_location_assignment PIN_H12 -to $framen
...
# Upper PCI 32-bit Core
proc 2C20_F256_32_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
}

# Master/Target PCI Core Only
proc 2C20_F256_32_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_F16 -to $gntn
	set_location_assignment PIN_G13 -to $reqn
}
...
# Lower PCI 32-bit Core
proc 2C70_F896_both_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_T22 -to $trdyn
	set_location_assignment PIN_T23 -to $framen
	set_location_assignment PIN_T26 -to $irdyn
	set_location_assignment PIN_T27 -to $stopn
	set_location_assignment PIN_T29 -to $devseln
	set_location_assignment PIN_R29 -to $rstn
	set_location_assignment PIN_AD30 -to $clk
	set_location_assignment PIN_U30 -to $cben\[0\]
	set_location_assignment PIN_U29 -to $cben\[1\]
	set_location_assignment PIN_U23 -to $cben\[2\]
	set_location_assignment PIN_V29 -to $cben\[3\]
	set_location_assignment PIN_Y28 -to $par
	set_location_assignment PIN_Y30 -to $serrn
	set_location_assignment PIN_Y29 -to $perrn
	set_location_assignment PIN_R27 -to $idsel
	set_location_assignment PIN_R26 -to $intan
	set_location_assignment PIN_L25 -to $ad\[0\]
	set_location_assignment PIN_L26 -to $ad\[1\]
	set_location_assignment PIN_L29 -to $ad\[2\]
	set_location_assignment PIN_L30 -to $ad\[3\]
	set_location_assignment PIN_M21 -to $ad\[4\]
	set_location_assignment PIN_M22 -to $ad\[5\]
	set_location_assignment PIN_M23 -to $ad\[6\]
	set_location_assignment PIN_M24 -to $ad\[7\]
	set_location_assignment PIN_M25 -to $ad\[8\]
	set_location_assignment PIN_M26 -to $ad\[9\]
	set_location_assignment PIN_M27 -to $ad\[10\]
	set_location_assignment PIN_M29 -to $ad\[11\]
	set_location_assignment PIN_M30 -to $ad\[12\]
	set_location_assignment PIN_N21 -to $ad\[13\]
	set_location_assignment PIN_N22 -to $ad\[14\]
	set_location_assignment PIN_N25 -to $ad\[15\]
	set_location_assignment PIN_N28 -to $ad\[16\]
	set_location_assignment PIN_N29 -to $ad\[17\]
	set_location_assignment PIN_P22 -to $ad\[18\]
	set_location_assignment PIN_P25 -to $ad\[19\]
	set_location_assignment PIN_P26 -to $ad\[20\]
	set_location_assignment PIN_P27 -to $ad\[21\]
	set_location_assignment PIN_P28 -to $ad\[22\]
	set_location_assignment PIN_P30 -to $ad\[23\]
	set_location_assignment PIN_T28 -to $ad\[24\]
	set_location_assignment PIN_V21 -to $ad\[25\]
	set_location_assignment PIN_V22 -to $ad\[26\]
	set_location_assignment PIN_V24 -to $ad\[27\]
	set_location_assignment PIN_W25 -to $ad\[28\]
	set_location_assignment PIN_W26 -to $ad\[29\]
	set_location_assignment PIN_W29 -to $ad\[30\]
	set_location_assignment PIN_W30 -to $ad\[31\]
}

# Upper PCI 32-bit Core
proc 2C70_F896_both_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
	set_location_assignment PIN_P29 -to $req64n
	set_location_assignment PIN_Y27 -to $par64
	set_location_assignment PIN_R23 -to $ack64n
	set_location_assignment PIN_U24 -to $cben\[4\]
	set_location_assignment PIN_U25 -to $cben\[5\]
	set_location_assignment PIN_V28 -to $cben\[6\]
	set_location_assignment PIN_W28 -to $cben\[7\]
	set_location_assignment PIN_C29 -to $ad\[32\]
	set_location_assignment PIN_C30 -to $ad\[33\]
	set_location_assignment PIN_D28 -to $ad\[34\]
	set_location_assignment PIN_D29 -to $ad\[35\]
	set_location_assignment PIN_E27 -to $ad\[36\]
	set_location_assignment PIN_E29 -to $ad\[37\]
	set_location_assignment PIN_E30 -to $ad\[38\]
	set_location_assignment PIN_F27 -to $ad\[39\]
	set_location_assignment PIN_F29 -to $ad\[40\]
	set_location_assignment PIN_F30 -to $ad\[41\]
	set_location_assignment PIN_G25 -to $ad\[42\]
	set_location_assignment PIN_G26 -to $ad\[43\]
	set_location_assignment PIN_G27 -to $ad\[44\]
	set_location_assignment PIN_G29 -to $ad\[45\]
	set_location_assignment PIN_H24 -to $ad\[46\]
	set_location_assignment PIN_H25 -to $ad\[47\]
	set_location_assignment PIN_H26 -to $ad\[48\]
	set_location_assignment PIN_H27 -to $ad\[49\]
	set_location_assignment PIN_H28 -to $ad\[50\]
	set_location_assignment PIN_H29 -to $ad\[51\]
	set_location_assignment PIN_H30 -to $ad\[52\]
	set_location_assignment PIN_J24 -to $ad\[53\]
	set_location_assignment PIN_J29 -to $ad\[54\]
	set_location_assignment PIN_J30 -to $ad\[55\]
	set_location_assignment PIN_K23 -to $ad\[56\]
	set_location_assignment PIN_K24 -to $ad\[57\]
	set_location_assignment PIN_K26 -to $ad\[58\]
	set_location_assignment PIN_K27 -to $ad\[59\]
	set_location_assignment PIN_K28 -to $ad\[60\]
	set_location_assignment PIN_K29 -to $ad\[61\]
	set_location_assignment PIN_L22 -to $ad\[62\]
	set_location_assignment PIN_L24 -to $ad\[63\]
}

# Master/Target PCI Core Only
proc 2C70_F896_both_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_R22 -to $gntn
	set_location_assignment PIN_R24 -to $reqn
}
...
# Lower PCI 32-bit Core
proc 2C20_2C35_2C50_F484_32_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_C19 -to $ad\[0\]
	set_location_assignment PIN_C20 -to $ad\[1\]
	set_location_assignment PIN_C21 -to $ad\[2\]
	set_location_assignment PIN_C22 -to $ad\[3\]
	set_location_assignment PIN_D19 -to $ad\[4\]
	set_location_assignment PIN_D20 -to $ad\[5\]
	set_location_assignment PIN_D21 -to $ad\[6\]
	set_location_assignment PIN_D22 -to $ad\[7\]
	set_location_assignment PIN_E20 -to $ad\[8\]
	set_location_assignment PIN_E21 -to $ad\[9\]
	set_location_assignment PIN_F20 -to $ad\[11\]
	set_location_assignment PIN_F21 -to $ad\[12\]
	set_location_assignment PIN_G17 -to $ad\[14\]
	set_location_assignment PIN_G18 -to $ad\[15\]
	set_location_assignment PIN_G21 -to $ad\[16\]
	set_location_assignment PIN_G22 -to $ad\[17\]
	set_location_assignment PIN_H17 -to $ad\[18\]
	set_location_assignment PIN_H18 -to $ad\[19\]
	set_location_assignment PIN_H19 -to $ad\[20\]
	set_location_assignment PIN_J17 -to $ad\[21\]
	set_location_assignment PIN_Y18 -to $ad\[29\]
	set_location_assignment PIN_Y19 -to $ad\[30\]
	set_location_assignment PIN_Y20 -to $ad\[31\]
	set_location_assignment PIN_E22 -to $ad\[10\]
	set_location_assignment PIN_F22 -to $ad\[13\]
	set_location_assignment PIN_J18 -to $ad\[22\]
	set_location_assignment PIN_J19 -to $ad\[23\]
	set_location_assignment PIN_J20 -to $ad\[24\]
	set_location_assignment PIN_U21 -to $ad\[25\]
	set_location_assignment PIN_W22 -to $ad\[28\]
	set_location_assignment PIN_W21 -to $ad\[27\]
	set_location_assignment PIN_V20 -to $ad\[26\]
	set_location_assignment PIN_N21 -to $cben\[0\]
	set_location_assignment PIN_T21 -to $cben\[1\]
	set_location_assignment PIN_V21 -to $cben\[2\]
	set_location_assignment PIN_Y22 -to $cben\[3\]
	set_location_assignment PIN_U22 -to $clk
	set_location_assignment PIN_L21 -to $rstn
	set_location_assignment PIN_L18 -to $trdyn
	set_location_assignment PIN_L19 -to $framen
	set_location_assignment PIN_J22 -to $idsel
	set_location_assignment PIN_K22 -to $intan
	set_location_assignment PIN_M18 -to $irdyn
	set_location_assignment PIN_M19 -to $stopn
	set_location_assignment PIN_N22 -to $devseln
	set_location_assignment PIN_R21 -to $par
	set_location_assignment PIN_R19 -to $perrn
	set_location_assignment PIN_R18 -to $serrn
}

# Upper PCI 32-bit Core
proc 2C20_2C35_2C50_F484_32_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
}

# Master/Target PCI Core Only
proc 2C20_2C35_2C50_F484_32_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_J21 -to $gntn
	set_location_assignment PIN_K21 -to $reqn
}

#*******************************************************
# 64-bit master/target - only MT64, T64
# 33/66MHz
# 3.3-V Applications
# History:
# 	09/27/2004: Created 
...
# Lower PCI 32-bit Core
proc 2C20_2C35_2C50_F484_64_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_Y3 -to $ad\[0\]
	set_location_assignment PIN_Y2 -to $ad\[1\]
	set_location_assignment PIN_Y1 -to $ad\[2\]
	set_location_assignment PIN_W5 -to $ad\[3\]
	set_location_assignment PIN_W4 -to $ad\[4\]
	set_location_assignment PIN_W3 -to $ad\[5\]
	set_location_assignment PIN_W2 -to $ad\[6\]
	set_location_assignment PIN_W1 -to $ad\[7\]
	set_location_assignment PIN_V2 -to $ad\[8\]
	set_location_assignment PIN_V1 -to $ad\[9\]
	set_location_assignment PIN_U2 -to $ad\[10\]
	set_location_assignment PIN_T6 -to $ad\[11\]
	set_location_assignment PIN_T5 -to $ad\[12\]
	set_location_assignment PIN_T3 -to $ad\[13\]
	set_location_assignment PIN_T2 -to $ad\[14\]
	set_location_assignment PIN_T1 -to $ad\[15\]
	set_location_assignment PIN_R6 -to $ad\[16\]
	set_location_assignment PIN_R5 -to $ad\[17\]
	set_location_assignment PIN_R2 -to $ad\[18\]
	set_location_assignment PIN_R1 -to $ad\[19\]
	set_location_assignment PIN_P6 -to $ad\[20\]
	set_location_assignment PIN_P5 -to $ad\[21\]
	set_location_assignment PIN_P2 -to $ad\[22\]
	set_location_assignment PIN_P1 -to $ad\[23\]
	set_location_assignment PIN_N6 -to $ad\[24\]
	set_location_assignment PIN_N4 -to $ad\[25\]
	set_location_assignment PIN_N3 -to $ad\[26\]
	set_location_assignment PIN_N2 -to $ad\[27\]
	set_location_assignment PIN_N1 -to $ad\[28\]
	set_location_assignment PIN_M6 -to $ad\[29\]
	set_location_assignment PIN_J4 -to $ad\[30\]
	set_location_assignment PIN_J2 -to $ad\[31\]
	set_location_assignment PIN_N21 -to $cben\[0\]
	set_location_assignment PIN_T21 -to $cben\[1\]
	set_location_assignment PIN_V21 -to $cben\[2\]
	set_location_assignment PIN_Y22 -to $cben\[3\]
...
# Upper PCI 32-bit Core
proc 2C20_2C35_2C50_F484_64_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
	set_location_assignment PIN_Y21 -to $cben\[4\]
	set_location_assignment PIN_T22 -to $cben\[5\]
	set_location_assignment PIN_P18 -to $cben\[6\]
	set_location_assignment PIN_P17 -to $cben\[7\]
	set_location_assignment PIN_V22 -to $ack64n
	set_location_assignment PIN_R22 -to $par64
	set_location_assignment PIN_U21 -to $req64n
	set_location_assignment PIN_C19 -to $ad\[32\]
	set_location_assignment PIN_C20 -to $ad\[33\]
	set_location_assignment PIN_C21 -to $ad\[34\]
	set_location_assignment PIN_C22 -to $ad\[35\]
	set_location_assignment PIN_D19 -to $ad\[36\]
	set_location_assignment PIN_D20 -to $ad\[37\]
	set_location_assignment PIN_D21 -to $ad\[38\]
	set_location_assignment PIN_D22 -to $ad\[39\]
	set_location_assignment PIN_E20 -to $ad\[40\]
	set_location_assignment PIN_E21 -to $ad\[41\]
	set_location_assignment PIN_E22 -to $ad\[42\]
	set_location_assignment PIN_F20 -to $ad\[43\]
	set_location_assignment PIN_F21 -to $ad\[44\]
	set_location_assignment PIN_G17 -to $ad\[45\]
	set_location_assignment PIN_G18 -to $ad\[46\]
	set_location_assignment PIN_G21 -to $ad\[47\]
	set_location_assignment PIN_G22 -to $ad\[48\]
	set_location_assignment PIN_H17 -to $ad\[49\]
	set_location_assignment PIN_H18 -to $ad\[50\]
	set_location_assignment PIN_H19 -to $ad\[51\]
	set_location_assignment PIN_J17 -to $ad\[52\]
	set_location_assignment PIN_J18 -to $ad\[53\]
	set_location_assignment PIN_J19 -to $ad\[54\]
	set_location_assignment PIN_J20 -to $ad\[55\]
	set_location_assignment PIN_R17 -to $ad\[56\]
	set_location_assignment PIN_U19 -to $ad\[57\]
	set_location_assignment PIN_V20 -to $ad\[58\]
	set_location_assignment PIN_W21 -to $ad\[59\]
	set_location_assignment PIN_W22 -to $ad\[60\]
	set_location_assignment PIN_Y18 -to $ad\[61\]
	set_location_assignment PIN_Y19 -to $ad\[62\]
	set_location_assignment PIN_Y20 -to $ad\[63\]
}

# Master/Target PCI Core Only
proc 2C20_2C35_2C50_F484_64_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_J21 -to $gntn
	set_location_assignment PIN_K21 -to $reqn
}
...
# Lower PCI 32-bit Core
proc 2C35_2C50_2C70_F672_both_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
...
# Upper PCI 32-bit Core
proc 2C35_2C50_2C70_F672_both_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
...
# Master/Target PCI Core Only
proc 2C35_2C50_2C70_F672_both_mstr_tgt {} {
	global gntn reqn	
...
puts "Info: You have sourced the Cyclone II PCI constraint file."
