# Stratix GX Constraint file.

# PCI_CF_Device_Family = Stratix GX
...
proc sanity_checks { speed device core  } {
    ...
    # Check if customer is targeting on StratixGX device, EP1SGX
    set device_family [lindex [get_part_info -family $device] 0] 
    if { $device_family == "Stratix GX" } {
    } else {
        puts "Error: This constraint file is specific to Stratix GX device family."
        puts "       You are not targeting a Stratix GX device."
...
proc pci_pin_asgn { device full_64 master core pin_list no_pins got_prefix got_suffix prefix suffix } {
    ...
    # check for ES
    set last_two [string range $device [expr ([string length $device] - 2)] [expr ([string length $device] - 1)] ]
    
    if { $last_two == "ES" } {
        set device_no_speed [string range $device 0 [expr ([string length $device] - 5)] ]
	} else {
		set device_no_speed [string range $device 0 [expr ([string length $device] - 3)] ]
    }   
        
    # get pin out group name
    set pinout_group [get_pinout_group_name $device_no_speed]
...
proc get_pinout_group_name { device_no_speed } {
    ...
    # array name == pin
    array set pin { EP1SGX10CF672   SGX10_F672}
    array set pin { EP1SGX10DF672   SGX10_F672}        
    
    array set pin { EP1SGX25CF672   SGX25_F672}
    array set pin { EP1SGX25DF672   SGX25_F672}
    array set pin { EP1SGX25FF672   SGX25_F672}        
    
    array set pin { EP1SGX25CF1020  SGX25_SGX40_F1020}
    array set pin { EP1SGX25DF1020  SGX25_SGX40_F1020}     
    array set pin { EP1SGX25FF1020  SGX25_SGX40_F1020}  
    
    array set pin { EP1SGX40DF1020  SGX25_SGX40_F1020}
    array set pin { EP1SGX40GF1020  SGX25_SGX40_F1020}    
...
# Quartus II Format
# 	set_global_assignment -name "DEVICE" "EP1SGX10CF672C6"
# 	set_global_assignment -name "DEVICE" "EP1SGX10DF672C6"

# Lower PCI 32-bit Core
proc SGX10_F672_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_D14 -to $clk	
	set_location_assignment PIN_E16 -to $devseln	
	set_location_assignment PIN_G16 -to $framen	
	set_location_assignment PIN_D18 -to $idsel	
	set_location_assignment PIN_E18 -to $intan	
	set_location_assignment PIN_G18 -to $irdyn	
	set_location_assignment PIN_E17 -to $par	
	set_location_assignment PIN_C16 -to $perrn	
	set_location_assignment PIN_B14 -to $rstn	
	set_location_assignment PIN_F17 -to $serrn	
	set_location_assignment PIN_E15 -to $stopn	
	set_location_assignment PIN_F18 -to $trdyn	
	set_location_assignment PIN_B18 -to $cben\[0\]	
	set_location_assignment PIN_C18 -to $cben\[1\]	
	set_location_assignment PIN_D17 -to $cben\[2\]	
	set_location_assignment PIN_C17 -to $cben\[3\]	
	set_location_assignment PIN_G9 -to $ad\[0\]	
	set_location_assignment PIN_D9 -to $ad\[1\]	
	set_location_assignment PIN_C9 -to $ad\[2\]	
	set_location_assignment PIN_B9 -to $ad\[3\]	
	set_location_assignment PIN_A9 -to $ad\[4\]	
	set_location_assignment PIN_G10 -to $ad\[5\]	
	set_location_assignment PIN_E10 -to $ad\[6\]	
	set_location_assignment PIN_A10 -to $ad\[7\]	
	set_location_assignment PIN_G11 -to $ad\[8\]	
	set_location_assignment PIN_E11 -to $ad\[9\]	
	set_location_assignment PIN_B15 -to $ad\[10\]	
	set_location_assignment PIN_M16 -to $ad\[11\]	
	set_location_assignment PIN_L16 -to $ad\[12\]	
	set_location_assignment PIN_H18 -to $ad\[13\]	
	set_location_assignment PIN_A18 -to $ad\[14\]	
	set_location_assignment PIN_D19 -to $ad\[15\]	
	set_location_assignment PIN_C19 -to $ad\[16\]	
	set_location_assignment PIN_B19 -to $ad\[17\]	
	set_location_assignment PIN_A19 -to $ad\[18\]	
	set_location_assignment PIN_D20 -to $ad\[19\]	
	set_location_assignment PIN_C20 -to $ad\[20\]	
	set_location_assignment PIN_B20 -to $ad\[21\]	
	set_location_assignment PIN_A20 -to $ad\[22\]	
	set_location_assignment PIN_C21 -to $ad\[23\]	
	set_location_assignment PIN_B21 -to $ad\[24\]	
	set_location_assignment PIN_A21 -to $ad\[25\]	
	set_location_assignment PIN_C22 -to $ad\[26\]	
	set_location_assignment PIN_B22 -to $ad\[27\]	
	set_location_assignment PIN_A22 -to $ad\[28\]	
	set_location_assignment PIN_B23 -to $ad\[29\]	
	set_location_assignment PIN_A23 -to $ad\[30\]	
	set_location_assignment PIN_B24 -to $ad\[31\]
}

# Upper PCI 32-bit Core
proc SGX10_F672_upper_32bit_core {} {
	global ack64n par64 req64n ad cben		
	set_location_assignment PIN_H16 -to $ack64n	
	set_location_assignment PIN_B3 -to $ad\[32\]	
	set_location_assignment PIN_E4 -to $ad\[33\]	
	set_location_assignment PIN_D4 -to $ad\[34\]	
	set_location_assignment PIN_C4 -to $ad\[35\]	
	set_location_assignment PIN_B4 -to $ad\[36\]	
	set_location_assignment PIN_A4 -to $ad\[37\]	
	set_location_assignment PIN_E5 -to $ad\[38\]	
	set_location_assignment PIN_D5 -to $ad\[39\]	
	set_location_assignment PIN_C5 -to $ad\[40\]	
	set_location_assignment PIN_B5 -to $ad\[41\]	
	set_location_assignment PIN_A5 -to $ad\[42\]	
	set_location_assignment PIN_E6 -to $ad\[43\]	
	set_location_assignment PIN_D6 -to $ad\[44\]	
	set_location_assignment PIN_C6 -to $ad\[45\]	
	set_location_assignment PIN_B6 -to $ad\[46\]	
	set_location_assignment PIN_A6 -to $ad\[47\]	
	set_location_assignment PIN_H7 -to $ad\[48\]	
	set_location_assignment PIN_G7 -to $ad\[49\]	
	set_location_assignment PIN_F7 -to $ad\[50\]	
	set_location_assignment PIN_E7 -to $ad\[51\]	
	set_location_assignment PIN_D7 -to $ad\[52\]	
	set_location_assignment PIN_C7 -to $ad\[53\]	
	set_location_assignment PIN_B7 -to $ad\[54\]	
	set_location_assignment PIN_A7 -to $ad\[55\]	
	set_location_assignment PIN_H8 -to $ad\[56\]	
	set_location_assignment PIN_G8 -to $ad\[57\]	
	set_location_assignment PIN_F8 -to $ad\[58\]	
	set_location_assignment PIN_E8 -to $ad\[59\]	
	set_location_assignment PIN_D8 -to $ad\[60\]	
	set_location_assignment PIN_C8 -to $ad\[61\]	
	set_location_assignment PIN_B8 -to $ad\[62\]	
	set_location_assignment PIN_A8 -to $ad\[63\]	
	set_location_assignment PIN_G17 -to $par64	
	set_location_assignment PIN_D15 -to $req64n	
	set_location_assignment PIN_A17 -to $cben\[4\]	
	set_location_assignment PIN_B16 -to $cben\[5\]	
	set_location_assignment PIN_F15 -to $cben\[6\]	
	set_location_assignment PIN_D16 -to $cben\[7\]	
}

# Master/Target PCI Core Only
proc SGX10_F672_mstr_tgt {} {
	global gntn reqn		
	set_location_assignment PIN_C15 -to $gntn	
	set_location_assignment PIN_B17 -to $reqn	
}
...
# Quartus II Format
# 	set_global_assignment -name "DEVICE" "EP1SGX25DF672C6"
# 	set_global_assignment -name "DEVICE" "EP1SGX25CF672C6"

# Lower PCI 32-bit Core
proc SGX25_F672_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_D14 -to $clk	
	set_location_assignment PIN_E16 -to $devseln	
	set_location_assignment PIN_G18 -to $framen	
	set_location_assignment PIN_D18 -to $idsel	
	set_location_assignment PIN_E18 -to $intan	
	set_location_assignment PIN_G16 -to $irdyn	
	set_location_assignment PIN_E17 -to $par	
	set_location_assignment PIN_B14 -to $rstn	
	set_location_assignment PIN_C16 -to $perrn	
	set_location_assignment PIN_F17 -to $serrn	
	set_location_assignment PIN_E15 -to $stopn	
	set_location_assignment PIN_H16 -to $trdyn	
	set_location_assignment PIN_G9 -to $ad\[0\]	
	set_location_assignment PIN_D9 -to $ad\[1\]	
	set_location_assignment PIN_C9 -to $ad\[2\]	
	set_location_assignment PIN_B9 -to $ad\[3\]	
...
# Upper PCI 32-bit Core
proc SGX25_F672_upper_32bit_core {} {
	global ack64n par64 req64n ad cben 
	set_location_assignment PIN_F18 -to $ack64n	
	set_location_assignment PIN_C3 -to $ad\[32\]	
	set_location_assignment PIN_B3 -to $ad\[33\]	
	set_location_assignment PIN_E4 -to $ad\[34\]	
	set_location_assignment PIN_D4 -to $ad\[35\]	
	set_location_assignment PIN_C4 -to $ad\[36\]	
	set_location_assignment PIN_B4 -to $ad\[37\]	
	set_location_assignment PIN_A4 -to $ad\[38\]	
	set_location_assignment PIN_E5 -to $ad\[39\]	
	set_location_assignment PIN_D5 -to $ad\[40\]	
	set_location_assignment PIN_C5 -to $ad\[41\]	
	set_location_assignment PIN_B5 -to $ad\[42\]	
	set_location_assignment PIN_A5 -to $ad\[43\]	
	set_location_assignment PIN_E6 -to $ad\[44\]	
	set_location_assignment PIN_D6 -to $ad\[45\]	
	set_location_assignment PIN_C6 -to $ad\[46\]	
	set_location_assignment PIN_B6 -to $ad\[47\]	
	set_location_assignment PIN_A6 -to $ad\[48\]	
	set_location_assignment PIN_H7 -to $ad\[49\]	
	set_location_assignment PIN_G7 -to $ad\[50\]	
	set_location_assignment PIN_F7 -to $ad\[51\]	
	set_location_assignment PIN_E7 -to $ad\[52\]	
	set_location_assignment PIN_D7 -to $ad\[53\]	
	set_location_assignment PIN_C7 -to $ad\[54\]	
	set_location_assignment PIN_B7 -to $ad\[55\]	
	set_location_assignment PIN_A7 -to $ad\[56\]	
	set_location_assignment PIN_H8 -to $ad\[57\]	
	set_location_assignment PIN_G8 -to $ad\[58\]	
	set_location_assignment PIN_E8 -to $ad\[59\]	
	set_location_assignment PIN_D8 -to $ad\[60\]	
	set_location_assignment PIN_C8 -to $ad\[61\]	
	set_location_assignment PIN_B8 -to $ad\[62\]	
...
#Quartus II Format
# 	set_global_assignment -name "DEVICE" "EP1SGX25DF1020C6"
# 	set_global_assignment -name "DEVICE" "EP1SGX25FF1020C6"
# 	set_global_assignment -name "DEVICE" "EP1SGX40DF1020C6"
# 	set_global_assignment -name "DEVICE" "EP1SGX40GF1020C6"

# Lower PCI 32-bit Core
proc SGX25_SGX40_F1020_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben 
	set_location_assignment PIN_C19 -to $clk	
	set_location_assignment PIN_B18 -to $rstn	
	set_location_assignment PIN_G22 -to $trdyn	
	set_location_assignment PIN_H22 -to $irdyn	
	set_location_assignment PIN_D19 -to $framen	
	set_location_assignment PIN_D20 -to $devseln	
	set_location_assignment PIN_F19 -to $stopn	
	set_location_assignment PIN_D21 -to $par	
	set_location_assignment PIN_A22 -to $cben\[0\]	
	set_location_assignment PIN_B21 -to $cben\[1\]	
	set_location_assignment PIN_A21 -to $cben\[2\]	
	set_location_assignment PIN_C21 -to $cben\[3\]	
	set_location_assignment PIN_E22 -to $serrn	
	set_location_assignment PIN_D22 -to $perrn	
	set_location_assignment PIN_F24 -to $ad\[0\]	
	set_location_assignment PIN_E24 -to $ad\[1\]	
	set_location_assignment PIN_D24 -to $ad\[2\]	
	set_location_assignment PIN_C24 -to $ad\[3\]	
	set_location_assignment PIN_B24 -to $ad\[4\]	
	set_location_assignment PIN_A24 -to $ad\[5\]	
	set_location_assignment PIN_F25 -to $ad\[6\]	
	set_location_assignment PIN_E25 -to $ad\[7\]	
	set_location_assignment PIN_D25 -to $ad\[8\]	
	set_location_assignment PIN_C25 -to $ad\[9\]	
	set_location_assignment PIN_B25 -to $ad\[10\]	
	set_location_assignment PIN_A25 -to $ad\[11\]	
	set_location_assignment PIN_F26 -to $ad\[12\]	
	set_location_assignment PIN_E26 -to $ad\[13\]	
	set_location_assignment PIN_D26 -to $ad\[14\]	
	set_location_assignment PIN_C26 -to $ad\[15\]	
	set_location_assignment PIN_B26 -to $ad\[16\]	
	set_location_assignment PIN_A26 -to $ad\[17\]	
	set_location_assignment PIN_E27 -to $ad\[18\]	
	set_location_assignment PIN_D27 -to $ad\[19\]	
	set_location_assignment PIN_C27 -to $ad\[20\]	
	set_location_assignment PIN_B27 -to $ad\[21\]	
	set_location_assignment PIN_A27 -to $ad\[22\]	
	set_location_assignment PIN_E28 -to $ad\[23\]	
	set_location_assignment PIN_D28 -to $ad\[24\]	
	set_location_assignment PIN_C29 -to $ad\[25\]	
	set_location_assignment PIN_B29 -to $ad\[26\]	
	set_location_assignment PIN_A29 -to $ad\[27\]	
	set_location_assignment PIN_C30 -to $ad\[28\]	
	set_location_assignment PIN_B30 -to $ad\[29\]	
	set_location_assignment PIN_C31 -to $ad\[30\]	
	set_location_assignment PIN_B31 -to $ad\[31\]	
	set_location_assignment PIN_C28 -to $idsel	
	set_location_assignment PIN_B28 -to $intan	
}

# Upper PCI 32-bit Core
proc SGX25_SGX40_F1020_upper_32bit_core {} {
	global ack64n par64 req64n ad cben 	
	set_location_assignment PIN_C22 -to $ack64n	
	set_location_assignment PIN_E21 -to $par64	
	set_location_assignment PIN_N18 -to $req64n	
	set_location_assignment PIN_J14 -to $ad\[32\]	
	set_location_assignment PIN_H14 -to $ad\[33\]	
	set_location_assignment PIN_E14 -to $ad\[34\]	
	set_location_assignment PIN_C14 -to $ad\[35\]	
	set_location_assignment PIN_B14 -to $ad\[36\]	
	set_location_assignment PIN_A14 -to $ad\[37\]	
	set_location_assignment PIN_M15 -to $ad\[38\]	
	set_location_assignment PIN_H15 -to $ad\[39\]	
	set_location_assignment PIN_L15 -to $ad\[40\]	
	set_location_assignment PIN_G15 -to $ad\[41\]	
	set_location_assignment PIN_F15 -to $ad\[42\]	
	set_location_assignment PIN_E15 -to $ad\[43\]	
	set_location_assignment PIN_D15 -to $ad\[44\]	
	set_location_assignment PIN_C15 -to $ad\[45\]	
	set_location_assignment PIN_B15 -to $ad\[46\]	
	set_location_assignment PIN_A15 -to $ad\[47\]	
	set_location_assignment PIN_N17 -to $ad\[48\]	
	set_location_assignment PIN_G17 -to $ad\[49\]	
	set_location_assignment PIN_J18 -to $ad\[50\]	
	set_location_assignment PIN_G18 -to $ad\[51\]	
	set_location_assignment PIN_K19 -to $ad\[52\]	
	set_location_assignment PIN_J22 -to $ad\[53\]	
	set_location_assignment PIN_B22 -to $ad\[54\]	
	set_location_assignment PIN_H23 -to $ad\[55\]	
	set_location_assignment PIN_G23 -to $ad\[56\]	
	set_location_assignment PIN_F23 -to $ad\[57\]	
	set_location_assignment PIN_E23 -to $ad\[58\]	
	set_location_assignment PIN_D23 -to $ad\[59\]	
	set_location_assignment PIN_C23 -to $ad\[60\]	
	set_location_assignment PIN_B23 -to $ad\[61\]	
	set_location_assignment PIN_A23 -to $ad\[62\]	
	set_location_assignment PIN_G24 -to $ad\[63\]	
	set_location_assignment PIN_C20 -to $cben\[4\]	
	set_location_assignment PIN_B20 -to $cben\[5\]	
	set_location_assignment PIN_F20 -to $cben\[6\]	
	set_location_assignment PIN_E19 -to $cben\[7\]	
}

# Master/Target PCI Core Only
proc SGX25_SGX40_F1020_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_A28 -to $reqn	
	set_location_assignment PIN_E20 -to $gntn
}
...
puts "Info: You have sourced the Stratix GX PCI constraint file."
