...
proc sanity_checks { speed device core  } {
    ...
    if { $device_family == "Stratix III" } {
            ...
            puts "Error: This constraint file is specific to Stratix III device family."
            puts "       You are not targeting a Stratix III device."
    ...
    if { ($core == "MT64" || $core == "T64") && ($speed == "66") && ($pin_count == "484" || $pin_count == "672") } {
            ...
            puts "       Change the Stratix III device package in your project"
            error ""
    }    
    ...
    #        puts "       Change the Stratix III device in your project"
    #        error ""        	
    #}  
}
...
puts "Info: You have sourced the Stratix III PCI constraint file."
