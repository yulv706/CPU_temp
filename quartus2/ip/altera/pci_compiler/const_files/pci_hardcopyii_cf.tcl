# HardCopy II Constraint file.

# PCI_CF_Device_Family = HardCopy II
...
if ![info exist pin_planner_group] {
	...
	#basic_pci_asgn $core $full_64 $hierarchy $master $pin_list $pci_timing $got_prefix $got_suffix $prefix $suffix
        generate_replacement_tan $pin_list $pci_timing $master $hierarchy $core $full_64
...
proc family_pci_asgn { master full_64 hierarchy pin_list got_prefix got_suffix prefix suffix } {
    ...
    set_instance_assignment -name "AUTO_PACKED_REGISTERS" OFF -to "$hierarchy\|low_ad_or_fb"   
    set_instance_assignment -name "AUTO_PACKED_REGISTERS" OFF -to "$hierarchy\|low_cben_or_fb"        
    set_instance_assignment -name "AUTO_PACKED_REGISTERS" OFF -to "$hierarchy\|low_cben_or_d"             
    if {$full_64} {
    	set_instance_assignment -name "AUTO_PACKED_REGISTERS" OFF -to "$hierarchy\|high_ad_or_fb"
    	set_instance_assignment -name "AUTO_PACKED_REGISTERS" OFF -to "$hierarchy\|high_cben_or_fb"
        set_instance_assignment -name "AUTO_PACKED_REGISTERS" OFF -to "$hierarchy\|high_cben_or_d"
    }
...
proc sanity_checks { speed device core  } {
    ...
    # Check if customer is targeting on HardCopy II device, EP2S
    set device_family [lindex [get_part_info -family $device] 0]        
    
    if { $device_family == "HardCopy II" } {
    } else {
            puts "Error: This constraint file is specific to HardCopy II device family."
            puts "       You are not targeting a HardCopy II device."
    ...
    if { ($core == "MT64" || $core == "T64") && ($speed == "66") && ($pin_count == "484" || $pin_count == "672") } {
            ...
            puts "       Change the HardCopy II device package in your project"
            error ""
    }    
    ...
    #        puts "       Change the HardCopy II device in your project"
    #        error ""        	
    #}  
}
...
proc get_pinout_group_name { device_no_speed } {
    ...
    # array name == pin
    array set pin { HC210_484      2S15_2S30_2S60_F484}
    array set pin { HC210W_484      2S90_F484}
    #array set pin { EP2S30_484      2S15_2S30_2S60_F484}
    #array set pin { EP2S60_484      2S15_2S30_2S60_F484}
    array set pin { HC220_672      2S15_2S30_2S60_F672}
    #array set pin { EP2S30_672      2S15_2S30_2S60_F672}
    #array set pin { EP2S60_672      2S15_2S30_2S60_F672}
    array set pin { HC220_780     2S60_2S90_F780}
    array set pin { HC230_1020     2S60_2S90_2S130_2S180_F1020}
    array set pin { HC240_1020     2S60_2S90_2S130_2S180_F1020}
    array set pin { HC240_1508     2S90_2S130_2S180_F1508}
...
# 02/27/2004    Added HardCopy II pinouts
...
proc 2S15_2S30_2S60_F484_lower_32bit_core {} {
	...
	#set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC210F484C
...
proc 2S15_2S30_2S60_F672_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC220F672C
...
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC230F1020C
  	...
  	# puts "HC230F1020C"
	set_location_assignment PIN_AF10 -to $ad\[31\]
	set_location_assignment PIN_AH11 -to $ad\[30\]
	set_location_assignment PIN_AG12 -to $ad\[29\]
	set_location_assignment PIN_AG11 -to $ad\[28\]
	set_location_assignment PIN_AG10 -to $ad\[27\]
	set_location_assignment PIN_AG9 -to $ad\[26\]
	set_location_assignment PIN_AG8 -to $ad\[25\]
	set_location_assignment PIN_AH9 -to $ad\[24\]
	set_location_assignment PIN_AG15 -to $ad\[23\]
	set_location_assignment PIN_AG14 -to $ad\[22\]
	set_location_assignment PIN_AG13 -to $ad\[21\]
	set_location_assignment PIN_AH14 -to $ad\[20\]
	set_location_assignment PIN_AH13 -to $ad\[19\]
	set_location_assignment PIN_AJ14 -to $ad\[18\]
	set_location_assignment PIN_AJ13 -to $ad\[17\]
	set_location_assignment PIN_AJ12 -to $ad\[16\]
	set_location_assignment PIN_AH5 -to $ad\[15\]
	set_location_assignment PIN_AH6 -to $ad\[14\]
	set_location_assignment PIN_AH7 -to $ad\[13\]
	set_location_assignment PIN_AH8 -to $ad\[12\]
	set_location_assignment PIN_AJ8 -to $ad\[11\]
	set_location_assignment PIN_AJ7 -to $ad\[10\]
	set_location_assignment PIN_AJ6 -to $ad\[9\]
	set_location_assignment PIN_AJ5 -to $ad\[8\]
	set_location_assignment PIN_AK9 -to $ad\[7\]
	set_location_assignment PIN_AL9 -to $ad\[6\]
	set_location_assignment PIN_AJ11 -to $ad\[5\]
	set_location_assignment PIN_AJ10 -to $ad\[4\]
	set_location_assignment PIN_AK10 -to $ad\[3\]
	set_location_assignment PIN_AK11 -to $ad\[2\]
	set_location_assignment PIN_AK12 -to $ad\[1\]
	set_location_assignment PIN_AK13 -to $ad\[0\]
	set_location_assignment PIN_AM4 -to $cben\[0\]
	set_location_assignment PIN_AL4 -to $cben\[1\]
	set_location_assignment PIN_AM5 -to $cben\[2\]
	set_location_assignment PIN_AL5 -to $cben\[3\]
	set_location_assignment PIN_AL11 -to $stopn
	set_location_assignment PIN_AL10 -to $devseln
	set_location_assignment PIN_AM16 -to $clk
	set_location_assignment PIN_AL16 -to $rstn
	set_location_assignment PIN_AM17 -to $irdyn
	set_location_assignment PIN_AK17 -to $trdyn
	set_location_assignment PIN_AM14 -to $framen
	set_location_assignment PIN_AM11 -to $idsel
	set_location_assignment PIN_AM9 -to $intan
	set_location_assignment PIN_AM8 -to $par
	set_location_assignment PIN_AK5 -to $perrn
	set_location_assignment PIN_AK4 -to $serrn
...
proc 2S60_2S90_2S130_2S180_F1020_upper_32bit_core {} {
	...
	#added
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC230F1020C	
	set_location_assignment PIN_AM26 -to $ad[63]
	set_location_assignment PIN_AL26 -to $ad[62]
	set_location_assignment PIN_AK26 -to $ad[61]
	set_location_assignment PIN_AJ26 -to $ad[60]
	set_location_assignment PIN_AJ25 -to $ad[59]
	set_location_assignment PIN_AK25 -to $ad[58]
	set_location_assignment PIN_AL25 -to $ad[57]
	set_location_assignment PIN_AM25 -to $ad[56]
	set_location_assignment PIN_AJ21 -to $ad[55]
	set_location_assignment PIN_AJ22 -to $ad[54]
	set_location_assignment PIN_AJ23 -to $ad[53]
	set_location_assignment PIN_AK24 -to $ad[52]
	set_location_assignment PIN_AK23 -to $ad[51]
	set_location_assignment PIN_AK22 -to $ad[50]
	set_location_assignment PIN_AK21 -to $ad[49]
	set_location_assignment PIN_AL21 -to $ad[48]
	set_location_assignment PIN_AL20 -to $ad[47]
	set_location_assignment PIN_AL22 -to $ad[46]
	set_location_assignment PIN_AL23 -to $ad[45]
	set_location_assignment PIN_AL24 -to $ad[44]
	set_location_assignment PIN_AM24 -to $ad[43]
	set_location_assignment PIN_AM23 -to $ad[42]
	set_location_assignment PIN_AM22 -to $ad[41]
	set_location_assignment PIN_AM21 -to $ad[40]
	set_location_assignment PIN_AE14 -to $ad[39]
	set_location_assignment PIN_AE13 -to $ad[38]
	set_location_assignment PIN_AE12 -to $ad[37]
	set_location_assignment PIN_AE11 -to $ad[36]
	set_location_assignment PIN_AE10 -to $ad[35]
	set_location_assignment PIN_AF13 -to $ad[34]
	set_location_assignment PIN_AF12 -to $ad[33]
	set_location_assignment PIN_AF11 -to $ad[32]
	set_location_assignment PIN_AM6 -to $cben[4]
	set_location_assignment PIN_AL6 -to $cben[5]
	set_location_assignment PIN_AM7 -to $cben[6]
	set_location_assignment PIN_AL7 -to $cben[7]
	set_location_assignment PIN_AL8 -to $par64
	set_location_assignment PIN_AM10 -to $ack64n
	set_location_assignment PIN_AL13 -to $req64n
...
proc 2S60_2S90_2S130_2S180_F1020_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_AM12 -to $gntn
	set_location_assignment PIN_AL14 -to $reqn      
}
...
proc 2S90_2S130_2S180_F1508_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC240F1508C
	set_location_assignment PIN_AR8 -to $ad\[31\]
	set_location_assignment PIN_AT7 -to $ad\[30\]
	set_location_assignment PIN_AT8 -to $ad\[29\]
	set_location_assignment PIN_AR9 -to $ad\[28\]
	set_location_assignment PIN_AT9 -to $ad\[27\]
	set_location_assignment PIN_AR10 -to $ad\[26\]
	set_location_assignment PIN_AT10 -to $ad\[25\]
	set_location_assignment PIN_AR11 -to $ad\[24\]
	set_location_assignment PIN_AT11 -to $ad\[23\]
	set_location_assignment PIN_AR12 -to $ad\[22\]
	set_location_assignment PIN_AT12 -to $ad\[21\]
	set_location_assignment PIN_AR13 -to $ad\[20\]
	set_location_assignment PIN_AT13 -to $ad\[19\]
	set_location_assignment PIN_AR14 -to $ad\[18\]
	set_location_assignment PIN_AT14 -to $ad\[17\]
	set_location_assignment PIN_AP8 -to $ad\[16\]
	set_location_assignment PIN_AV5 -to $ad\[15\]
	set_location_assignment PIN_AU5 -to $ad\[14\]
	set_location_assignment PIN_AV6 -to $ad\[13\]
	set_location_assignment PIN_AU6 -to $ad\[12\]
	set_location_assignment PIN_AV7 -to $ad\[11\]
	set_location_assignment PIN_AU7 -to $ad\[10\]
	set_location_assignment PIN_AV8 -to $ad\[9\]
	set_location_assignment PIN_AU8 -to $ad\[8\]
	set_location_assignment PIN_AV10 -to $ad\[7\]
	set_location_assignment PIN_AU10 -to $ad\[6\]
	set_location_assignment PIN_AV11 -to $ad\[5\]
	set_location_assignment PIN_AU11 -to $ad\[4\]
	set_location_assignment PIN_AV12 -to $ad\[3\]
	set_location_assignment PIN_AU12 -to $ad\[2\]
	set_location_assignment PIN_AV13 -to $ad\[1\]
	set_location_assignment PIN_AU13 -to $ad\[0\]
	set_location_assignment PIN_AV17 -to $cben\[0\]
	set_location_assignment PIN_AV16 -to $cben\[1\]
	set_location_assignment PIN_AV15 -to $cben\[2\]
	set_location_assignment PIN_AV14 -to $cben\[3\]
	set_location_assignment PIN_AW10 -to $stopn
	set_location_assignment PIN_AW9 -to $devseln
	set_location_assignment PIN_AU20 -to $clk
	set_location_assignment PIN_AT21 -to $rstn
	set_location_assignment PIN_AW20 -to $irdyn
	set_location_assignment PIN_AU19 -to $trdyn
	set_location_assignment PIN_AW8 -to $framen
	set_location_assignment PIN_AW7 -to $idsel
	set_location_assignment PIN_AT17 -to $intan
	set_location_assignment PIN_AW13 -to $par
	set_location_assignment PIN_AW11 -to $perrn
	set_location_assignment PIN_AW12 -to $serrn
...
proc 2S90_2S130_2S180_F1508_upper_32bit_core {} {
	...
	# added
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC240F1508C	
	set_location_assignment PIN_AT16 -to $ad\[63\]
	set_location_assignment PIN_AT15 -to $ad\[62\]
	set_location_assignment PIN_AR16 -to $ad\[61\]
	set_location_assignment PIN_AR15 -to $ad\[60\]
	set_location_assignment PIN_AM19 -to $ad\[59\]
	set_location_assignment PIN_AN19 -to $ad\[58\]
	set_location_assignment PIN_AP19 -to $ad\[57\]
	set_location_assignment PIN_AM18 -to $ad\[56\]
	set_location_assignment PIN_AN18 -to $ad\[55\]
	set_location_assignment PIN_AP18 -to $ad\[54\]
	set_location_assignment PIN_AM17 -to $ad\[53\]
	set_location_assignment PIN_AN17 -to $ad\[52\]
	set_location_assignment PIN_AN16 -to $ad\[51\]
	set_location_assignment PIN_AP16 -to $ad\[50\]
	set_location_assignment PIN_AM15 -to $ad\[49\]
	set_location_assignment PIN_AN15 -to $ad\[48\]
	set_location_assignment PIN_AM14 -to $ad\[47\]
	set_location_assignment PIN_AN14 -to $ad\[46\]
	set_location_assignment PIN_AP14 -to $ad\[45\]
	set_location_assignment PIN_AM13 -to $ad\[44\]
	set_location_assignment PIN_AN13 -to $ad\[43\]
	set_location_assignment PIN_AP13 -to $ad\[42\]
	set_location_assignment PIN_AM12 -to $ad\[41\]
	set_location_assignment PIN_AN12 -to $ad\[40\]
	set_location_assignment PIN_AN11 -to $ad\[39\]
	set_location_assignment PIN_AP11 -to $ad\[38\]
	set_location_assignment PIN_AP10 -to $ad\[37\]
	set_location_assignment PIN_AL17 -to $ad\[36\]
	set_location_assignment PIN_AK17 -to $ad\[35\]
	set_location_assignment PIN_AL15 -to $ad\[34\]
	set_location_assignment PIN_AK14 -to $ad\[33\]
	set_location_assignment PIN_AL13 -to $ad\[32\]
	set_location_assignment PIN_AU14 -to $cben\[4\]
	set_location_assignment PIN_AU15 -to $cben\[5\]
	set_location_assignment PIN_AU16 -to $cben\[6\]
	set_location_assignment PIN_AU17 -to $cben\[7\]
	set_location_assignment PIN_AW17 -to $par64
	set_location_assignment PIN_AW14 -to $ack64n
	set_location_assignment PIN_AW15 -to $req64n
...
proc 2S90_2S130_2S180_F1508_mstr_tgt {} { 
	global gntn reqn
	set_location_assignment PIN_AW5 -to $gntn
	set_location_assignment PIN_AW6 -to $reqn
...
# Lower PCI 32-bit Core
proc 2S60_2S90_F780_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC220F780C
	...
	set_location_assignment PIN_AH11 -to $framen
	set_location_assignment PIN_AG11 -to $idsel
	set_location_assignment PIN_AE9 -to $intan
	set_location_assignment PIN_AE11 -to $par
	set_location_assignment PIN_AD8 -to $perrn
	set_location_assignment PIN_AE13 -to $serrn
	set_location_assignment PIN_AF5 -to $cben\[0\]
	set_location_assignment PIN_AG5 -to $cben\[1\]
	set_location_assignment PIN_AG4 -to $cben\[2\]
	set_location_assignment PIN_AF4 -to $cben\[3\]
	set_location_assignment PIN_AD13 -to $stopn
	set_location_assignment PIN_AH10 -to $devseln
	set_location_assignment PIN_AH24 -to $ad\[31\]
	set_location_assignment PIN_AH23 -to $ad\[30\]
	set_location_assignment PIN_AH22 -to $ad\[29\]
	set_location_assignment PIN_AH21 -to $ad\[28\]
	set_location_assignment PIN_AH20 -to $ad\[27\]
	set_location_assignment PIN_AH19 -to $ad\[26\]
	set_location_assignment PIN_AH18 -to $ad\[25\]
	set_location_assignment PIN_AH17 -to $ad\[24\]
	set_location_assignment PIN_Y11 -to $ad\[23\]
	set_location_assignment PIN_Y9 -to $ad\[22\]
	set_location_assignment PIN_AA10 -to $ad\[21\]
	set_location_assignment PIN_AA11 -to $ad\[20\]
	set_location_assignment PIN_AB14 -to $ad\[19\]
	set_location_assignment PIN_AB13 -to $ad\[18\]
	set_location_assignment PIN_AB12 -to $ad\[17\]
	set_location_assignment PIN_AB10 -to $ad\[16\]
	set_location_assignment PIN_AC13 -to $ad\[15\]
	set_location_assignment PIN_AC12 -to $ad\[14\]
	set_location_assignment PIN_AC11 -to $ad\[13\]
	set_location_assignment PIN_AC10 -to $ad\[12\]
	set_location_assignment PIN_AC9 -to $ad\[11\]
	set_location_assignment PIN_AB9 -to $ad\[10\]
	set_location_assignment PIN_AB8 -to $ad\[9\]
	set_location_assignment PIN_AC7 -to $ad\[8\]
	set_location_assignment PIN_AG10 -to $ad\[7\]
	set_location_assignment PIN_AG9 -to $ad\[6\]
	set_location_assignment PIN_AG8 -to $ad\[5\]
	set_location_assignment PIN_AH9 -to $ad\[4\]
	set_location_assignment PIN_AH8 -to $ad\[3\]
	set_location_assignment PIN_AH7 -to $ad\[2\]
	set_location_assignment PIN_AH6 -to $ad\[1\]
	set_location_assignment PIN_AH5 -to $ad\[0\]
}

# Upper PCI 32-bit Core
proc 2S60_2S90_F780_upper_32bit_core {} {
	global ack64n par64 req64n ad cben
	#$added
#	set_global_assignment -name DEVICE_TECHNOLOGY_MIGRATION_LIST HC230F1020C	
	set_location_assignment PIN_AF8 -to $cben\[4\]
	set_location_assignment PIN_AF7 -to $cben\[5\]
	set_location_assignment PIN_AE7 -to $cben\[6\]
	set_location_assignment PIN_AE8 -to $cben\[7\]
	set_location_assignment PIN_AH4 -to $ack64n
	set_location_assignment PIN_AD11 -to $par64
	set_location_assignment PIN_AC19 -to $ad\[63\]
	set_location_assignment PIN_AD22 -to $ad\[59\]
	set_location_assignment PIN_AD18 -to $ad\[56\]
	set_location_assignment PIN_AE18 -to $ad\[50\]
	set_location_assignment PIN_AE16 -to $ad\[49\]
	set_location_assignment PIN_AF25 -to $ad\[48\]
	set_location_assignment PIN_AF22 -to $ad\[46\]
	set_location_assignment PIN_AF21 -to $ad\[45\]
	set_location_assignment PIN_AF20 -to $ad\[44\]
	set_location_assignment PIN_AF19 -to $ad\[43\]
	set_location_assignment PIN_AF18 -to $ad\[42\]
	set_location_assignment PIN_AG24 -to $ad\[39\]
	set_location_assignment PIN_AG23 -to $ad\[38\]
	set_location_assignment PIN_AG21 -to $ad\[36\]
	set_location_assignment PIN_AG20 -to $ad\[35\]
	set_location_assignment PIN_AG18 -to $ad\[33\]
	set_location_assignment PIN_AH25 -to $ad\[32\]
	set_location_assignment PIN_AH22 -to $ad\[29\]
	set_location_assignment PIN_AG19 -to $ad\[34\]
	set_location_assignment PIN_AG22 -to $ad\[37\]
	set_location_assignment PIN_AG25 -to $ad\[40\]
	set_location_assignment PIN_AF17 -to $ad\[41\]
	set_location_assignment PIN_AF24 -to $ad\[47\]
	set_location_assignment PIN_AE20 -to $ad\[51\]
	set_location_assignment PIN_AE22 -to $ad\[52\]
	set_location_assignment PIN_AE23 -to $ad\[53\]
	set_location_assignment PIN_AD16  -to $ad\[54\]
	set_location_assignment PIN_AD17  -to $ad\[55\]
	set_location_assignment PIN_AD19  -to $ad\[57\]
	set_location_assignment PIN_AD21  -to $ad\[58\]
	set_location_assignment PIN_AC17 -to $ad\[61\]
	set_location_assignment PIN_AC18 -to $ad\[62\]
	set_location_assignment PIN_AC20 -to $ad\[60\]
	set_location_assignment PIN_AF12 -to $req64n
}

# Master/Target PCI Core Only
proc 2S60_2S90_F780_mstr_tgt {} {
	global gntn reqn	
	set_location_assignment PIN_AG7 -to $gntn
	set_location_assignment PIN_AG6 -to $reqn
}
...
#####################################################
# Generating TAN files in specific to top-level file
#####################################################

proc generate_replacement_tan { pin_list pci_timing master hierarchy core full_64 } {
        global quartus
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ack64n par64 req64n ad cben gntn reqn        
	set core_lower [string tolower $core]
	# Printing information to this Line
	...
	set input_delay_value_max [expr $speed - $pci_tsu_value]
	set input_delay_value_min [expr {$pci_th_value}]
	set output_delay_value_tco [expr {$pci_tco_value}]
	set output_delay_value [expr {$pci_toff_value}]
	set number_of_pins [llength $pin_list]
	...
	# Filtering Pin direction based on cores
	foreach asgn_pin $pin_list {
		if { $master } {
			if { $asgn_pin == "$trdyn" || [ regexp "$ad" $asgn_pin] || $asgn_pin == "$devseln" || $asgn_pin == "$par" || $asgn_pin == "$par64" ||  [regexp "$cben" $asgn_pin] || $asgn_pin == "$framen"  || $asgn_pin == "$req64n"  || $asgn_pin == "$irdyn" || $asgn_pin == "$stopn" || $asgn_pin == "$perrn" || $asgn_pin == "$ack64n" } {
                                lappend bidir_pin $asgn_pin
				...
				lappend input_pin $asgn_pin	
			} elseif { $asgn_pin == "$intan" || $asgn_pin == "$serrn"  } {  
				lappend output_pin $asgn_pin
			}
		} else {
			if { [regexp "$ad" $asgn_pin] || $asgn_pin == "$par" || $asgn_pin == "$par64" } {
	...
	# create_clock -period "$speed" clk
	foreach bidir $bidir_pin {
		set_instance_assignment -name IO_STANDARD "3.3-V PCI" -to $bidir
		set_instance_assignment -name PCI_IO ON -to $bidir
		set_output_delay -max -clk_ref clk -to $bidir "0ns"
		set_instance_assignment -name SETUP_RELATIONSHIP -from * -to $bidir $output_delay_value_tco
		set_input_delay -max -clk_ref clk -to $bidir $input_delay_value_max
		set_input_delay -min -clk_ref clk -to $bidir $input_delay_value_min

		}
        

	foreach input $input_pin {
		set_instance_assignment -name IO_STANDARD "3.3-V PCI" -to $input
		set_instance_assignment -name PCI_IO ON -to $input

		if { [regexp ".*gntn.*" $input]} {
		set_input_delay -max -clk_ref clk -to $input $input_delay_value_max_ptp
		set_input_delay -min -clk_ref clk -to $input $input_delay_value_min
		} else {
		set_input_delay -max -clk_ref clk -to $input $input_delay_value_max
		set_input_delay -min -clk_ref clk -to $input $input_delay_value_min
		}	
	}
		
	foreach output $output_pin {
		set_instance_assignment -name IO_STANDARD "3.3-V PCI" -to $output
		set_instance_assignment -name PCI_IO ON -to $output
		
		if { [regexp ".*reqn.*" $output] } {
		set_output_delay -max -clk_ref clk -to $output "0ns"
		set_instance_assignment -name SETUP_RELATIONSHIP -from * -to $output $output_delay_value_tco 
		} else {
		set_output_delay -max -clk_ref clk -to $output "0ns"
		set_instance_assignment -name SETUP_RELATIONSHIP -from * -to $output $output_delay_value_tco
                }        
	...
	set n 0
	while {$n<32} {
		set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_t:trg\|adoe -to $ad\[$n\] $output_delay_value

		incr n
	}
	
	set_instance_assignment -name setup_relationship -from $hierarchy\|par_oeR -to $par $output_delay_value
	set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_t:trg\|targ_oeR_reg -to $devseln $output_delay_value
	set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_t:trg\|targ_oeR_reg -to $stopn $output_delay_value 
	set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_t:trg\|targ_oeR_reg -to $trdyn $output_delay_value 
	set_instance_assignment -name setup_relationship -from $hierarchy\|perr_oe_r -to $perrn $output_delay_value
			
	# 64-bit cores
	if {$full_64} {
		set_instance_assignment -name setup_relationship -from $hierarchy\|par_oeR -to $par64 $output_delay_value
		set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_t:trg\|targ_oeR_reg -to $ack64n $output_delay_value
		set n 32
	...
	if {$master} {	
		set n 0
		while {$n<32} {
			set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_m:mstr\|ad_oer -to $ad\[$n\] $output_delay_value
			incr n
		}
		set n 0
		while {$n<4} {
			set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_m:mstr\|cbe_oer_not -to $cben\[$n\] $output_delay_value
			incr n
		}	
		set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_m:mstr\|cbe_oer_not -to $framen $output_delay_value
		set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_m:mstr\|irdy_oer -to $irdyn $output_delay_value 
		# Master/Target 64-bit cores
		if {$full_64} {
			set n 32
			while {$n<64} {
			...
			set_instance_assignment -name setup_relationship -from $hierarchy\|pci$core_lower\_m:mstr\|cbe_oer_not -to $req64n $output_delay_value
		}		
