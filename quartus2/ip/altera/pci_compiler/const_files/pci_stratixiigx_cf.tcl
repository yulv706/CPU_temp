...
proc sanity_checks { speed device core  } {
    ...
    if { $device_family == "Stratix II GX" } {
    } else {
            puts "Error: This constraint file is specific to Stratix II GX device family."
            puts "       You are not targeting a Stratix II GX device."
    ...
    if { ($core == "MT64" || $core == "T64") && ($speed == "66") && ($pin_count == "484" || $pin_count == "672") } {
            ...
            puts "       Change the Stratix II GX device package in your project"
            error ""
    }    
...
proc get_pinout_group_name { device_no_speed } {
    ...
    # array name == pin
# array name == pin
    array set pin { EP2SGX30_780       2SGX30_2SGX60_F780}
    array set pin { EP2SGX30C_780      2SGX30_2SGX60_F780}
    array set pin { EP2SGX30D_780      2SGX30_2SGX60_F780}
    array set pin { EP2SGX60_780       2SGX30_2SGX60_F780}
    array set pin { EP2SGX60C_780      2SGX30_2SGX60_F780}
    array set pin { EP2SGX60D_780      2SGX30_2SGX60_F780}
    array set pin { EP2SGX60_1152      2SGX60_2SGX90_F1152}
    array set pin { EP2SGX60E_1152     2SGX60_2SGX90_F1152}
    array set pin { EP2SGX90_1152      2SGX60_2SGX90_F1152}
    array set pin { EP2SGX90E_1152     2SGX60_2SGX90_F1152}
    array set pin { EP2SGX90F_1508     2SGX90_F1508}
    array set pin { EP2SGX130_1508     2SGX130_F1508}
    array set pin { EP2SGX130G_1508    2SGX130_F1508}
...
# Quartus II Format
#       set_global_assignment -name "DEVICE" "EP2SGX30CF780C3"
#       set_global_assignment -name "DEVICE" "EP2SGX30DF780C3"
#       set_global_assignment -name "DEVICE" "EP2SGX60CF780C3"
#       set_global_assignment -name "DEVICE" "EP2SGX60DF780C3"

# Lower PCI 32-bit Core
proc 2SGX30_2SGX60_F780_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
	set_location_assignment PIN_AG17 -to $clk
	set_location_assignment PIN_AH17 -to $rstn
	set_location_assignment PIN_AH9 -to $framen
	set_location_assignment PIN_AH8 -to $idsel
	set_location_assignment PIN_AG13 -to $par
	set_location_assignment PIN_AG10 -to $perrn
	set_location_assignment PIN_AG11 -to $serrn
	set_location_assignment PIN_AH10 -to $devseln
	set_location_assignment PIN_AH11 -to $stopn
    set_location_assignment PIN_AG16 -to $irdyn
    set_location_assignment PIN_AE15 -to $trdyn
    set_location_assignment PIN_AH12 -to $intan
	set_location_assignment PIN_AE10 -to $cben\[0\]
	set_location_assignment PIN_AF10 -to $cben\[1\]
	set_location_assignment PIN_AE9 -to $cben\[2\]
	set_location_assignment PIN_AF9 -to $cben\[3\]
	set_location_assignment PIN_W15 -to $ad\[31\]
    set_location_assignment PIN_Y15 -to $ad\[30\]
    set_location_assignment PIN_Y13 -to $ad\[29\]
	set_location_assignment PIN_V13 -to $ad\[28\]
	set_location_assignment PIN_V11 -to $ad\[27\]
	set_location_assignment PIN_W9 -to $ad\[26\]
	set_location_assignment PIN_W10 -to $ad\[25\]
    set_location_assignment PIN_W11 -to $ad\[24\]
	set_location_assignment PIN_W12 -to $ad\[23\]
    set_location_assignment PIN_Y10 -to $ad\[22\]
	set_location_assignment PIN_Y11 -to $ad\[21\]
	set_location_assignment PIN_AA11 -to $ad\[20\]
	set_location_assignment PIN_AB8 -to $ad\[19\]
    set_location_assignment PIN_AC8 -to $ad\[18\]
    set_location_assignment PIN_AB9 -to $ad\[17\]
    set_location_assignment PIN_AC9 -to $ad\[16\]
    set_location_assignment PIN_AB10 -to $ad\[15\]
	set_location_assignment PIN_AB11 -to $ad\[14\]
	set_location_assignment PIN_AC11 -to $ad\[13\]
    set_location_assignment PIN_AB12 -to $ad\[12\]
	set_location_assignment PIN_AC12 -to $ad\[11\]
	set_location_assignment PIN_AB13 -to $ad\[10\]
	set_location_assignment PIN_AC13 -to $ad\[9\]
	set_location_assignment PIN_AC14 -to $ad\[8\]
	set_location_assignment PIN_AD10 -to $ad\[7\]
	set_location_assignment PIN_AD11 -to $ad\[6\]
	set_location_assignment PIN_AD13 -to $ad\[5\]
	set_location_assignment PIN_AE13 -to $ad\[4\]
	set_location_assignment PIN_AF12 -to $ad\[3\]
	set_location_assignment PIN_AE12 -to $ad\[2\]
	set_location_assignment PIN_AF11 -to $ad\[1\]
	set_location_assignment PIN_AE11 -to $ad\[0\]
}

# Upper PCI 32-bit Core
proc 2SGX30_2SGX60_F780_upper_32bit_core {} {
	global ack64n par64 req64n ad cben	
	set_location_assignment PIN_AE24 -to $ad\[63\]
	set_location_assignment PIN_AE23 -to $ad\[62\]
	set_location_assignment PIN_AE22 -to $ad\[61\]
	set_location_assignment PIN_AE21 -to $ad\[60\]
	set_location_assignment PIN_AE20 -to $ad\[59\]
	set_location_assignment PIN_AE19 -to $ad\[58\]
	set_location_assignment PIN_AE18 -to $ad\[57\]
	set_location_assignment PIN_AF26 -to $ad\[56\]
	set_location_assignment PIN_AF25 -to $ad\[55\]
	set_location_assignment PIN_AF24 -to $ad\[54\]
	set_location_assignment PIN_AF23 -to $ad\[53\]
	set_location_assignment PIN_AF22 -to $ad\[52\]
	set_location_assignment PIN_AF21 -to $ad\[51\]
	set_location_assignment PIN_AF20 -to $ad\[50\]
	set_location_assignment PIN_AF19 -to $ad\[49\]
	set_location_assignment PIN_AF18 -to $ad\[48\]
	set_location_assignment PIN_AF17 -to $ad\[47\]
	set_location_assignment PIN_AG26 -to $ad\[46\]
	set_location_assignment PIN_AG25 -to $ad\[45\]
	set_location_assignment PIN_AG23 -to $ad\[44\]
	set_location_assignment PIN_AG22 -to $ad\[43\]
	set_location_assignment PIN_AG20 -to $ad\[42\]
	set_location_assignment PIN_AG19 -to $ad\[41\]
    set_location_assignment PIN_AH26 -to $ad\[40\]
	set_location_assignment PIN_AH25 -to $ad\[39\]
	set_location_assignment PIN_AH24 -to $ad\[38\]
	set_location_assignment PIN_AH23 -to $ad\[37\]
	set_location_assignment PIN_AH22 -to $ad\[36\]
	set_location_assignment PIN_AH21 -to $ad\[35\]
	set_location_assignment PIN_AH20 -to $ad\[34\]
	set_location_assignment PIN_AH19 -to $ad\[33\]
	set_location_assignment PIN_AH18 -to $ad\[32\]
	set_location_assignment PIN_AE8 -to $cben\[4\]
	set_location_assignment PIN_AF8 -to $cben\[5\]
	set_location_assignment PIN_AE7 -to $cben\[6\]
	set_location_assignment PIN_AF7 -to $cben\[7\]
	set_location_assignment PIN_AH13 -to $req64n
	set_location_assignment PIN_AE17 -to $ack64n
	set_location_assignment PIN_AF13 -to $par64

}

# Master/Target PCI Core Only
proc 2SGX30_2SGX60_F780_mstr_tgt {} { 
	global gntn reqn
	set_location_assignment PIN_AH7 -to $gntn
	set_location_assignment PIN_AG8 -to $reqn
}
...
#       set_global_assignment -name "DEVICE" "EP2SGX60EF1152C3"
#       set_global_assignment -name "DEVICE" "EP2SGX90GF1152C3" 


# Lower PCI 32-bit Core
proc 2SGX60_2SGX90_F1152_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
    set_location_assignment PIN_AM19 -to $clk
    set_location_assignment PIN_AN19 -to $rstn
    set_location_assignment PIN_AK19 -to $irdyn
    set_location_assignment PIN_AP19 -to $trdyn
    set_location_assignment PIN_AP18 -to $intan
	set_location_assignment PIN_AP12 -to $stopn
	set_location_assignment PIN_AP10 -to $framen
	set_location_assignment PIN_AP9 -to $idsel
	set_location_assignment PIN_AP15 -to $par
	set_location_assignment PIN_AN10 -to $perrn
	set_location_assignment PIN_AN11 -to $serrn
	set_location_assignment PIN_AP11 -to $devseln
	set_location_assignment PIN_AL13 -to $cben\[0\]
	set_location_assignment PIN_AM13 -to $cben\[1\]
	set_location_assignment PIN_AN13 -to $cben\[2\]
	set_location_assignment PIN_AP13 -to $cben\[3\]
	set_location_assignment PIN_AJ11 -to $ad\[31\]
	set_location_assignment PIN_AH11 -to $ad\[30\]
	set_location_assignment PIN_AJ10 -to $ad\[29\]
	set_location_assignment PIN_AH10 -to $ad\[28\]
	set_location_assignment PIN_AJ9 -to $ad\[27\]
	set_location_assignment PIN_AH9 -to $ad\[26\]
	set_location_assignment PIN_AH8 -to $ad\[25\]
	set_location_assignment PIN_AK11 -to $ad\[24\]
	set_location_assignment PIN_AH7 -to $ad\[23\]
	set_location_assignment PIN_AJ7 -to $ad\[22\]
	set_location_assignment PIN_AJ8 -to $ad\[21\]
	set_location_assignment PIN_AK8 -to $ad\[20\]
	set_location_assignment PIN_AL7 -to $ad\[19\]
	set_location_assignment PIN_AL8 -to $ad\[18\]
	set_location_assignment PIN_AM7 -to $ad\[17\]
	set_location_assignment PIN_AM8 -to $ad\[16\]
	set_location_assignment PIN_AM9 -to $ad\[15\]
	set_location_assignment PIN_AL9 -to $ad\[14\]
	set_location_assignment PIN_AM10 -to $ad\[13\]
	set_location_assignment PIN_AL10 -to $ad\[12\]
	set_location_assignment PIN_AM11 -to $ad\[11\]
	set_location_assignment PIN_AL11 -to $ad\[10\]
	set_location_assignment PIN_AM12 -to $ad\[9\]
	set_location_assignment PIN_AL12 -to $ad\[8\]
	set_location_assignment PIN_AK14 -to $ad\[7\]
	set_location_assignment PIN_AL15 -to $ad\[6\]
	set_location_assignment PIN_AM15 -to $ad\[5\]
	set_location_assignment PIN_AM16 -to $ad\[4\]
	set_location_assignment PIN_AL16 -to $ad\[3\]
	set_location_assignment PIN_AK16 -to $ad\[2\]
	set_location_assignment PIN_AJ17 -to $ad\[1\]
	set_location_assignment PIN_AH17 -to $ad\[0\]

}

# Upper PCI 32-bit Core
proc 2SGX60_2SGX90_F1152_upper_32bit_core {} {
	global ack64n par64 req64n ad cben	
	set_location_assignment PIN_AL14 -to $cben\[4\]
	set_location_assignment PIN_AM14 -to $cben\[5\]
	set_location_assignment PIN_AN14 -to $cben\[6\]
	set_location_assignment PIN_AP14 -to $cben\[7\]
	set_location_assignment PIN_AP16 -to $ack64n
	set_location_assignment PIN_AN16 -to $req64n
	set_location_assignment PIN_AN8 -to $par64
	set_location_assignment PIN_AJ18 -to $ad\[63\]
	set_location_assignment PIN_AH18 -to $ad\[62\]
	set_location_assignment PIN_AC16 -to $ad\[61\]
	set_location_assignment PIN_AC15 -to $ad\[60\]
	set_location_assignment PIN_AC14 -to $ad\[59\]
	set_location_assignment PIN_AC13 -to $ad\[58\]
	set_location_assignment PIN_AD14 -to $ad\[57\]
	set_location_assignment PIN_AD13 -to $ad\[56\]
	set_location_assignment PIN_AE14 -to $ad\[55\]
	set_location_assignment PIN_AE13 -to $ad\[54\]
	set_location_assignment PIN_AF14 -to $ad\[53\]
	set_location_assignment PIN_AF13 -to $ad\[52\]
	set_location_assignment PIN_AG14 -to $ad\[51\]
	set_location_assignment PIN_AG13 -to $ad\[50\]
	set_location_assignment PIN_AG11 -to $ad\[49\]
	set_location_assignment PIN_AF11 -to $ad\[48\]
	set_location_assignment PIN_AE11 -to $ad\[47\]
	set_location_assignment PIN_AG10 -to $ad\[46\]
	set_location_assignment PIN_AF10 -to $ad\[45\]
	set_location_assignment PIN_AE10 -to $ad\[44\]
	set_location_assignment PIN_AE9 -to $ad\[43\]
	set_location_assignment PIN_AG8 -to $ad\[42\]
	set_location_assignment PIN_AH12 -to $ad\[41\]
	set_location_assignment PIN_AJ12 -to $ad\[40\]
	set_location_assignment PIN_AH13 -to $ad\[39\]
	set_location_assignment PIN_AJ13 -to $ad\[38\]
	set_location_assignment PIN_AH14 -to $ad\[37\]
	set_location_assignment PIN_AJ14 -to $ad\[36\]
	set_location_assignment PIN_AH15 -to $ad\[35\]
	set_location_assignment PIN_AJ15 -to $ad\[34\]
	set_location_assignment PIN_AH16 -to $ad\[33\]
	set_location_assignment PIN_AJ16 -to $ad\[32\]


}

# Master/Target PCI Core Only
proc 2SGX60_2SGX90_F1152_mstr_tgt {} { 
	global gntn reqn
	set_location_assignment PIN_AP7 -to $gntn
	set_location_assignment PIN_AP8 -to $reqn
}
...
#       set_global_assignment -name "DEVICE" "EP2SGX90EF1508C3"
#       set_global_assignment -name "DEVICE" "EP2SGX90FF1508C3"

######
# Lower PCI 32-bit Core
proc 2SGX90_F1508_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
        set_location_assignment PIN_AW22 -to $clk
        set_location_assignment PIN_AV22 -to $rstn
        set_location_assignment PIN_AW20 -to $irdyn
        set_location_assignment PIN_AV21 -to $trdyn
        set_location_assignment PIN_AW17 -to $intan
        set_location_assignment PIN_AW14 -to $stopn
        set_location_assignment PIN_AW12 -to $framen
        set_location_assignment PIN_AW11 -to $idsel
        set_location_assignment PIN_AV15 -to $par
        set_location_assignment PIN_AV12 -to $perrn
        set_location_assignment PIN_AV13 -to $serrn
        set_location_assignment PIN_AW13 -to $devseln
        set_location_assignment PIN_AU19 -to $cben\[0\]
        set_location_assignment PIN_AU18 -to $cben\[1\]
        set_location_assignment PIN_AU17 -to $cben\[2\]
        set_location_assignment PIN_AU16 -to $cben\[3\]
        set_location_assignment PIN_AP10 -to $ad\[31\]
        set_location_assignment PIN_AN10 -to $ad\[30\]
        set_location_assignment PIN_AN11 -to $ad\[29\]
        set_location_assignment PIN_AN12 -to $ad\[28\]
        set_location_assignment PIN_AP12 -to $ad\[27\]
        set_location_assignment PIN_AR12 -to $ad\[26\]
        set_location_assignment PIN_AU9 -to $ad\[25\]
        set_location_assignment PIN_AT9 -to $ad\[24\]
        set_location_assignment PIN_AU10 -to $ad\[23\]
        set_location_assignment PIN_AT10 -to $ad\[22\]
        set_location_assignment PIN_AU11 -to $ad\[21\]
        set_location_assignment PIN_AT11 -to $ad\[20\]
        set_location_assignment PIN_AU12 -to $ad\[19\]
        set_location_assignment PIN_AT12 -to $ad\[18\]
        set_location_assignment PIN_AU13 -to $ad\[17\]
        set_location_assignment PIN_AT13 -to $ad\[16\]
        set_location_assignment PIN_AU14 -to $ad\[15\]
        set_location_assignment PIN_AT14 -to $ad\[14\]
        set_location_assignment PIN_AU15 -to $ad\[13\]
        set_location_assignment PIN_AT15 -to $ad\[12\]
        set_location_assignment PIN_AN16 -to $ad\[11\]
        set_location_assignment PIN_AP16 -to $ad\[10\]
        set_location_assignment PIN_AN17 -to $ad\[9\]
        set_location_assignment PIN_AP17 -to $ad\[8\]
        set_location_assignment PIN_AW18 -to $ad\[7\]
        set_location_assignment PIN_AR18 -to $ad\[6\]
        set_location_assignment PIN_AN18 -to $ad\[5\]
        set_location_assignment PIN_AP18 -to $ad\[4\]
        set_location_assignment PIN_AP19 -to $ad\[3\]
        set_location_assignment PIN_AN19 -to $ad\[2\]
        set_location_assignment PIN_AV18 -to $ad\[1\]
        set_location_assignment PIN_AR15 -to $ad\[0\]


}

# Upper PCI 32-bit Core
proc 2SGX90_F1508_upper_32bit_core {} {
	global ack64n par64 req64n ad cben	
        set_location_assignment PIN_AW15 -to $ack64n
        set_location_assignment PIN_AW16 -to $req64n
        set_location_assignment PIN_AV16 -to $par64
        set_location_assignment PIN_AT16 -to $cben\[4\]
        set_location_assignment PIN_AT17 -to $cben\[5\]
        set_location_assignment PIN_AT18 -to $cben\[6\]
        set_location_assignment PIN_AT19 -to $cben\[7\]
        set_location_assignment PIN_AM13 -to $ad\[63\]
        set_location_assignment PIN_AL13 -to $ad\[62\]
        set_location_assignment PIN_AK13 -to $ad\[61\]
        set_location_assignment PIN_AM16 -to $ad\[60\]
        set_location_assignment PIN_AM15 -to $ad\[59\]
        set_location_assignment PIN_AL16 -to $ad\[58\]
        set_location_assignment PIN_AL15 -to $ad\[57\]
        set_location_assignment PIN_AK16 -to $ad\[56\]
        set_location_assignment PIN_AK15 -to $ad\[55\]
        set_location_assignment PIN_AJ16 -to $ad\[54\]
        set_location_assignment PIN_AJ15 -to $ad\[53\]
        set_location_assignment PIN_AH16 -to $ad\[52\]
        set_location_assignment PIN_AH15 -to $ad\[51\]
        set_location_assignment PIN_AH14 -to $ad\[50\]
        set_location_assignment PIN_AG14 -to $ad\[49\]
        set_location_assignment PIN_AG15 -to $ad\[48\]
        set_location_assignment PIN_AG16 -to $ad\[47\]
        set_location_assignment PIN_AG17 -to $ad\[46\]
        set_location_assignment PIN_AG18 -to $ad\[45\]
        set_location_assignment PIN_AF18 -to $ad\[44\]
        set_location_assignment PIN_AG19 -to $ad\[43\]
        set_location_assignment PIN_AF19 -to $ad\[42\]
        set_location_assignment PIN_AH20 -to $ad\[41\]
        set_location_assignment PIN_AG20 -to $ad\[40\]
        set_location_assignment PIN_AG21 -to $ad\[39\]
        set_location_assignment PIN_AF21 -to $ad\[38\]
        set_location_assignment PIN_AN15 -to $ad\[37\]
        set_location_assignment PIN_AP15 -to $ad\[36\]
        set_location_assignment PIN_AN14 -to $ad\[35\]
        set_location_assignment PIN_AP14 -to $ad\[34\]
        set_location_assignment PIN_AN13 -to $ad\[33\]
        set_location_assignment PIN_AP13 -to $ad\[32\]

}

# Master/Target PCI Core Only
proc 2SGX90_F1508_mstr_tgt {} {
	global gntn reqn
        set_location_assignment PIN_AW9 -to $gntn
        set_location_assignment PIN_AW10 -to $reqn
...
#       set_global_assignment -name "DEVICE" "EP2SGX130GF1508C3" 


# Lower PCI 32-bit Core
proc 2SGX130_F1508_lower_32bit_core {} {
	global clk rstn devseln framen idsel intan irdyn par perrn serrn stopn trdyn ad cben
        set_location_assignment PIN_AW22 -to $clk
        set_location_assignment PIN_AV22 -to $rstn
        set_location_assignment PIN_AW20 -to $irdyn
...
# Upper PCI 32-bit Core
proc 2SGX130_F1508_upper_32bit_core {} {
	global ack64n par64 req64n ad cben	
        set_location_assignment PIN_AW15 -to $ack64n
        set_location_assignment PIN_AW16 -to $req64n
        set_location_assignment PIN_AV16 -to $par64
        ...
        set_location_assignment PIN_AT18 -to $cben\[6\]
        set_location_assignment PIN_AT19 -to $cben\[7\]
        set_location_assignment PIN_AH16 -to $ad\[63\]
        set_location_assignment PIN_AH15 -to $ad\[62\]
        set_location_assignment PIN_AH14 -to $ad\[61\]
        set_location_assignment PIN_AJ16 -to $ad\[60\]
        set_location_assignment PIN_AJ15 -to $ad\[59\]
        set_location_assignment PIN_AM19 -to $ad\[58\]
        set_location_assignment PIN_AK18 -to $ad\[57\]
        set_location_assignment PIN_AL18 -to $ad\[56\]
        set_location_assignment PIN_AM18 -to $ad\[55\]
        set_location_assignment PIN_AK16 -to $ad\[54\]
        set_location_assignment PIN_AL16 -to $ad\[53\]
        set_location_assignment PIN_AM16 -to $ad\[52\]
        set_location_assignment PIN_AK15 -to $ad\[51\]
        set_location_assignment PIN_AL15 -to $ad\[50\]
        set_location_assignment PIN_AM15 -to $ad\[49\]
        set_location_assignment PIN_AK13 -to $ad\[48\]
        set_location_assignment PIN_AL13 -to $ad\[47\]
        set_location_assignment PIN_AM13 -to $ad\[46\]
        set_location_assignment PIN_AG15 -to $ad\[45\]
        set_location_assignment PIN_AG16 -to $ad\[44\]
        set_location_assignment PIN_AF16 -to $ad\[43\]
        set_location_assignment PIN_AG14 -to $ad\[42\]
        set_location_assignment PIN_AE16 -to $ad\[41\]
        set_location_assignment PIN_AF15 -to $ad\[40\]
        set_location_assignment PIN_AE14 -to $ad\[39\]
        set_location_assignment PIN_AE15 -to $ad\[38\]
        set_location_assignment PIN_AN15 -to $ad\[37\]
        set_location_assignment PIN_AP15 -to $ad\[36\]
        set_location_assignment PIN_AN14 -to $ad\[35\]
        set_location_assignment PIN_AP14 -to $ad\[34\]
...
puts "Info: You have sourced the Stratix II GX PCI constraint file."
