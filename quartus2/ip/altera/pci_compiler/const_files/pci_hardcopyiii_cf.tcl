...
# PCI_CF_Date_Of_Creation (MM/DD/YY)= 09/08/06
# PCI_Quartus_Version = Quartus II 6.1 or higher
# PCI_Compiler_Version = 6.0 or higher
...
proc sanity_checks { speed device core  } {
    ...
    # Check if customer is targeting on Stratix III device, EP2S
    set device_family [lindex [get_part_info -family $device] 0]        

    if { $device_family == "HardCopy III" } {
    } else {
            puts "Error: This constraint file is specific to HardCopy III device family."
            puts "       You are not targeting a HardCopy III device."
    ...
    if { ($core == "MT64" || $core == "T64") && ($speed == "66") && ($pin_count == "484" || $pin_count == "672") } {
            ...
            puts "       Change the HardCopy III device package in your project"
            error ""
    }    
    ...
    #        puts "       Change the HardCopy III device in your project"
    #        error ""        	
    #}  
}
...
# 02/27/2004    Added Stratix III pinouts
...
puts "Info: You have sourced the HardCopy III PCI constraint file."
