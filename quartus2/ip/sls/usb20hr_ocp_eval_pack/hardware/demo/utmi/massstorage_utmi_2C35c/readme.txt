...
//****************************
Steps for demonstrate Mass Storage application on 2c35 board RevC with UTMI Snap On board(Rev5).

   1>	Connect USB Blaster on J24 port(JTAG) of the board and Snap on Board(USB2.0 UTMI Rev5) on SC Headers J11,J12 and J13
